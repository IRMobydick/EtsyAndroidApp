...
public class ActivityState implements Serializable, Cloneable {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        this.enabled = Util.readBooleanField(readFields, ResponseConstants.ENABLED, true);
