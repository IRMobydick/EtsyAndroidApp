...
public class ActivityPackage implements Serializable {
    ...
    static {
        serialPersistentFields = new ObjectStreamField[]{new ObjectStreamField(ResponseConstants.PATH, String.class), new ObjectStreamField("clientSdk", String.class), new ObjectStreamField("parameters", Map.class), new ObjectStreamField("activityKind", ActivityKind.class), new ObjectStreamField("suffix", String.class)};
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        this.path = Util.readStringField(readFields, ResponseConstants.PATH, null);
