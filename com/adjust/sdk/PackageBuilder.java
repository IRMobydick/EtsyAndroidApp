...
class PackageBuilder {
    ...
    public ActivityPackage buildSessionPackage() {
        ...
        defaultActivityPackage.setSuffix(StringUtils.EMPTY);
    ...
    public ActivityPackage buildEventPackage(AdjustEvent adjustEvent) {
        ...
        addString(defaultParameters, EtsyRequest.PARAM_CURRENCY, adjustEvent.currency);
    ...
    public ActivityPackage buildClickPackage(String str, long j) {
        ...
        addMapJson(idsParameters, ResponseConstants.PARAMS, this.extraParameters);
    ...
    private void injectDeviceInfo(Map<String, String> map) {
        ...
        addString(map, EtsyRequest.PARAM_LANGUAGE, this.deviceInfo.language);
        addString(map, StructuredShopShippingEstimate.TYPE_COUNTRY, this.deviceInfo.country);
    ...
    private void injectConfig(Map<String, String> map) {
        ...
        addBoolean(map, "device_known", this.adjustConfig.knownDevice);
        addBoolean(map, "needs_attribution_data", Boolean.valueOf(this.adjustConfig.hasListener()));
