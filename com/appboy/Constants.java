...
public final class Constants {
    ...
    public static final long LOCATION_UPDATE_TIME_INTERVAL_DEFAULT_MS = 3600000;
    public static final long LOCATION_UPDATE_TIME_INTERVAL_LOCAL_CONFIG_MINIMUM_MS = 300000;
    public static final boolean NETWORK_LOGGING = true;

    static {
        APPBOY_LOG_TAG_PREFIX = String.format("%s v%s ", new Object[]{APPBOY, APPBOY_SDK_VERSION});
