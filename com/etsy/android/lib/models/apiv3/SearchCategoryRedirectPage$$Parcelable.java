...
import com.etsy.android.lib.models.cardviewelement.BasicSectionHeader$$PackageHelper;
import com.etsy.android.lib.models.cardviewelement.ListSection;
import com.etsy.android.lib.models.cardviewelement.ListSection$$PackageHelper;
import com.etsy.android.lib.models.cardviewelement.Page;
import com.etsy.android.lib.models.cardviewelement.Page$$PackageHelper;
...
public class SearchCategoryRedirectPage$$Parcelable implements android.os.Parcelable, ax<SearchCategoryRedirectPage> {
    public static final ar CREATOR;
    private SearchCategoryRedirectPage searchCategoryRedirectPage$$0;

    static {
        CREATOR = new ar();
    }

    public SearchCategoryRedirectPage$$Parcelable(Parcel parcel) {
        SearchCategoryRedirectPage searchCategoryRedirectPage;
        if (parcel.readInt() == -1) {
            searchCategoryRedirectPage = null;
        } else {
            searchCategoryRedirectPage = readcom_etsy_android_lib_models_apiv3_SearchCategoryRedirectPage(parcel);
        }
        this.searchCategoryRedirectPage$$0 = searchCategoryRedirectPage;
    }

    public SearchCategoryRedirectPage$$Parcelable(SearchCategoryRedirectPage searchCategoryRedirectPage) {
        this.searchCategoryRedirectPage$$0 = searchCategoryRedirectPage;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.searchCategoryRedirectPage$$0 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        m2375x41ca87d7(this.searchCategoryRedirectPage$$0, parcel, i);
    }

    private SearchCategoryRedirectPage readcom_etsy_android_lib_models_apiv3_SearchCategoryRedirectPage(Parcel parcel) {
        Page page;
        SearchWithAds searchWithAds;
        TaxonomyNode taxonomyNode = null;
        SearchCategoryRedirectPage searchCategoryRedirectPage = new SearchCategoryRedirectPage();
        searchCategoryRedirectPage.mFilterParams = (EtsyArray) parcel.readParcelable(SearchCategoryRedirectPage$$Parcelable.class.getClassLoader());
        if (parcel.readInt() == -1) {
            page = null;
        } else {
            page = readcom_etsy_android_lib_models_cardviewelement_Page(parcel);
        }
        searchCategoryRedirectPage.mCategoryLandingPage = page;
        if (parcel.readInt() == -1) {
            searchWithAds = null;
        } else {
            searchWithAds = readcom_etsy_android_lib_models_apiv3_SearchWithAds(parcel);
        }
        searchCategoryRedirectPage.mSearchWithAds = searchWithAds;
        if (parcel.readInt() != -1) {
            taxonomyNode = readcom_etsy_android_lib_models_TaxonomyNode(parcel);
        }
        searchCategoryRedirectPage.mTaxonomyNode = taxonomyNode;
        return searchCategoryRedirectPage;
    }
    ...
    private Page readcom_etsy_android_lib_models_cardviewelement_Page(Parcel parcel) {
        ...
        List list = null;
        Page page = new Page();
        Page$$PackageHelper.accessPage$FS$mMetadata(page, (BaseModel) parcel.readSerializable());
        Page$$PackageHelper.accessPage$FS$mTitle(page, parcel.readString());
        if (parcel.readInt() == -1) {
            messageCard = null;
        } else {
            messageCard = readcom_etsy_android_lib_models_homescreen_MessageCard(parcel);
        }
        Page$$PackageHelper.accessPage$FS$mMessageCard(page, messageCard);
        ...
        Page$$PackageHelper.accessPage$FS$mListSections(page, list);
        return page;
    }
    ...
    private ListSection readcom_etsy_android_lib_models_cardviewelement_ListSection(Parcel parcel) {
        ...
        ListSection$$PackageHelper.accessListSection$FS$mIsHorizontal(listSection, z);
        if (parcel.readInt() == -1) {
            basicSectionHeader = null;
        } else {
            basicSectionHeader = m2373x7fb48a11(parcel);
        }
        ListSection$$PackageHelper.accessListSection$FS$mHeader(listSection, basicSectionHeader);
        ListSection$$PackageHelper.accessListSection$FS$mItems(listSection, new IBaseRecyclerViewElementParcelConverter().fromParcel(parcel));
        ListSection$$PackageHelper.accessListSection$FS$mPageLink(listSection, (PageLink) parcel.readSerializable());
        ListSection$$PackageHelper.accessListSection$FS$mLayoutState(listSection, parcel.readParcelable(SearchCategoryRedirectPage$$Parcelable.class.getClassLoader()));
        return listSection;
    }

    private BasicSectionHeader m2373x7fb48a11(Parcel parcel) {
        BasicSectionHeader basicSectionHeader = new BasicSectionHeader();
        BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FS$mViewType(basicSectionHeader, parcel.readInt());
        BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FS$title(basicSectionHeader, parcel.readString());
        BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FS$subtitle(basicSectionHeader, parcel.readString());
    ...
    private FacetCountListMap readcom_etsy_android_lib_models_apiv3_FacetCountListMap(Parcel parcel) {
        ...
        if (parcel.readInt() == -1) {
            ...
            marketplaceFacets = m2372xfbbf7fac(parcel);
        }
    ...
    private MarketplaceFacets m2372xfbbf7fac(Parcel parcel) {
        boolean z;
        boolean z2 = true;
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        listingCard.mFundOnEtsyCampaign = (FundOnEtsyCampaign) parcel.readParcelable(SearchCategoryRedirectPage$$Parcelable.class.getClassLoader());
        if (parcel.readInt() != -1) {
    ...
    private SearchGroup readcom_etsy_android_lib_models_apiv3_SearchGroup(Parcel parcel) {
        ...
        searchGroup.mFilterValues = (EtsyArray) parcel.readParcelable(SearchCategoryRedirectPage$$Parcelable.class.getClassLoader());
        int readInt = parcel.readInt();
        if (readInt < 0) {
            list = null;
        } else {
    ...
    private void m2375x41ca87d7(SearchCategoryRedirectPage searchCategoryRedirectPage, Parcel parcel, int i) {
        parcel.writeParcelable(searchCategoryRedirectPage.mFilterParams, i);
        if (searchCategoryRedirectPage.mCategoryLandingPage == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            writecom_etsy_android_lib_models_cardviewelement_Page(searchCategoryRedirectPage.mCategoryLandingPage, parcel, i);
        }
        if (searchCategoryRedirectPage.mSearchWithAds == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            writecom_etsy_android_lib_models_apiv3_SearchWithAds(searchCategoryRedirectPage.mSearchWithAds, parcel, i);
        }
        if (searchCategoryRedirectPage.mTaxonomyNode == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        writecom_etsy_android_lib_models_TaxonomyNode(searchCategoryRedirectPage.mTaxonomyNode, parcel, i);
    }

    private void writecom_etsy_android_lib_models_cardviewelement_Page(Page page, Parcel parcel, int i) {
        parcel.writeSerializable(Page$$PackageHelper.accessPage$FG$mMetadata(page));
        parcel.writeString(Page$$PackageHelper.accessPage$FG$mTitle(page));
        if (Page$$PackageHelper.accessPage$FG$mMessageCard(page) == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            writecom_etsy_android_lib_models_homescreen_MessageCard(Page$$PackageHelper.accessPage$FG$mMessageCard(page), parcel, i);
        }
        if (Page$$PackageHelper.accessPage$FG$mListSections(page) == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(Page$$PackageHelper.accessPage$FG$mListSections(page).size());
        for (ListSection listSection : Page$$PackageHelper.accessPage$FG$mListSections(page)) {
            if (listSection == null) {
                parcel.writeInt(-1);
            } else {
                parcel.writeInt(1);
    ...
    private void writecom_etsy_android_lib_models_cardviewelement_ListSection(ListSection listSection, Parcel parcel, int i) {
        parcel.writeInt(ListSection$$PackageHelper.accessListSection$FG$mIsHorizontal(listSection) ? 1 : 0);
        if (ListSection$$PackageHelper.accessListSection$FG$mHeader(listSection) == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2376x3265be9a(ListSection$$PackageHelper.accessListSection$FG$mHeader(listSection), parcel, i);
        }
        new IBaseRecyclerViewElementParcelConverter().toParcel(ListSection$$PackageHelper.accessListSection$FG$mItems(listSection), parcel);
        parcel.writeSerializable(ListSection$$PackageHelper.accessListSection$FG$mPageLink(listSection));
        parcel.writeParcelable(ListSection$$PackageHelper.accessListSection$FG$mLayoutState(listSection), i);
    }

    private void m2376x3265be9a(BasicSectionHeader basicSectionHeader, Parcel parcel, int i) {
        parcel.writeInt(BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FG$mViewType(basicSectionHeader));
        parcel.writeString(BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FG$title(basicSectionHeader));
        parcel.writeString(BasicSectionHeader$$PackageHelper.accessBasicSectionHeader$FG$subtitle(basicSectionHeader));
    }
    ...
    private void writecom_etsy_android_lib_models_apiv3_FacetCountListMap(FacetCountListMap facetCountListMap, Parcel parcel, int i) {
        if (facetCountListMap.mMarketplaceFacets == null) {
            ...
            parcel.writeInt(1);
            m2374x648ccf03(facetCountListMap.mMarketplaceFacets, parcel, i);
        }
    ...
    private void m2374x648ccf03(MarketplaceFacets marketplaceFacets, Parcel parcel, int i) {
        int i2;
        int i3 = 1;
    ...
    public SearchCategoryRedirectPage getParcel() {
        return this.searchCategoryRedirectPage$$0;
    }
}
