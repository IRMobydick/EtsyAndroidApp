...
public class FindsShopModule$$Parcelable implements android.os.Parcelable, ax<FindsShopModule> {
    public static final FindsShopModule$$Parcelable CREATOR;
    private FindsShopModule findsShopModule$$0;

    static {
        CREATOR = new FindsShopModule$$Parcelable();
    }

    public FindsShopModule$$Parcelable(Parcel parcel) {
        FindsShopModule findsShopModule;
        if (parcel.readInt() == -1) {
            findsShopModule = null;
        } else {
            findsShopModule = readcom_etsy_android_lib_models_finds_FindsShopModule(parcel);
        }
        this.findsShopModule$$0 = findsShopModule;
    }

    public FindsShopModule$$Parcelable(FindsShopModule findsShopModule) {
        this.findsShopModule$$0 = findsShopModule;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.findsShopModule$$0 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        writecom_etsy_android_lib_models_finds_FindsShopModule(this.findsShopModule$$0, parcel, i);
    }

    private FindsShopModule readcom_etsy_android_lib_models_finds_FindsShopModule(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
        int i2 = 0;
        List list2 = null;
        FindsShopModule findsShopModule = new FindsShopModule();
        ...
        findsShopModule.mPages = list;
        findsShopModule.mType = parcel.readString();
        ...
        findsShopModule.mShops = list;
        findsShopModule.mText = parcel.readString();
        findsShopModule.mCta = parcel.readString();
        findsShopModule.mTitle = parcel.readString();
        readInt = parcel.readInt();
        if (readInt < 0) {
            list = null;
        } else {
        ...
        findsShopModule.mListings = list;
        readInt = parcel.readInt();
        if (readInt < 0) {
            list = null;
        } else {
            ...
            for (i = 0; i < readInt; i++) {
                if (parcel.readInt() == -1) {
                    ...
                    obj = m2676x9a940b4(parcel);
                }
                arrayList.add(obj);
            }
            obj = arrayList;
        }
        findsShopModule.mSections = list;
        findsShopModule.mGiftCardBannerImage = (GiftCardBannerImage) parcel.readSerializable();
        i = parcel.readInt();
        if (i >= 0) {
            arrayList = new ArrayList();
            while (i2 < i) {
        ...
        findsShopModule.mCategories = list2;
        return findsShopModule;
    }
    ...
    private LocalStore readcom_etsy_android_lib_models_LocalStore(Parcel parcel) {
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((LocalStoreImage) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
            }
    ...
    private LocalMarketCard readcom_etsy_android_lib_models_LocalMarketCard(Parcel parcel) {
        ...
        if (i >= 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                list2.add((LocalStoreImage) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
            }
        }
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listingCard, (FundOnEtsyCampaign) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private Section m2676x9a940b4(Parcel parcel) {
        Header header;
        Footer footer;
        List list = null;
        ...
        if (parcel.readInt() == -1) {
            ...
            header = m2674x58e42ade(parcel);
        }
        section.mHeader = header;
        if (parcel.readInt() == -1) {
            footer = null;
        } else {
            footer = m2673x560dfdec(parcel);
        }
    ...
    private Header m2674x58e42ade(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
    ...
    private Listing readcom_etsy_android_lib_models_Listing(Parcel parcel) {
        ...
        Listing$$PackageHelper.accessListing$FS$mMostRecentUpdate(listing, (ListingUpdate) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() == -1) {
            etsyMoney = null;
        } else {
            etsyMoney = readcom_etsy_android_lib_core_EtsyMoney(parcel);
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((ListingOption) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
            }
            obj = arrayList;
        }
        ...
        Listing$$PackageHelper.accessListing$FS$mFundOnEtsyCampaign(listing, (com.etsy.android.lib.models.FundOnEtsyCampaign) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
        i = parcel.readInt();
        if (i < 0) {
            list = null;
        } else {
    ...
    private Footer m2673x560dfdec(Parcel parcel) {
        FindsUrl findsUrl;
        List list;
        ArrayList arrayList;
        int i;
    ...
    private FindsTwoTitledListingsModule.Listing m2675x9f127c53(Parcel parcel) {
        boolean z;
        EtsyId etsyId;
        EtsyMoney etsyMoney;
        EtsyId etsyId2 = null;
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listing, (FundOnEtsyCampaign) parcel.readParcelable(FindsShopModule$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private void writecom_etsy_android_lib_models_finds_FindsShopModule(FindsShopModule findsShopModule, Parcel parcel, int i) {
        if (findsShopModule.mPages == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(findsShopModule.mPages.size());
            for (Page page : findsShopModule.mPages) {
                if (page == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        parcel.writeString(findsShopModule.mType);
        if (findsShopModule.mShops == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(findsShopModule.mShops.size());
            for (ShopCard shopCard : findsShopModule.mShops) {
                if (shopCard == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        parcel.writeString(findsShopModule.mText);
        parcel.writeString(findsShopModule.mCta);
        parcel.writeString(findsShopModule.mTitle);
        if (findsShopModule.mListings == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(findsShopModule.mListings.size());
            for (ListingCard listingCard : findsShopModule.mListings) {
                if (listingCard == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        if (findsShopModule.mSections == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(findsShopModule.mSections.size());
            for (Section section : findsShopModule.mSections) {
                if (section == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
                    m2680xba85dc3d(section, parcel, i);
                }
            }
        }
        parcel.writeSerializable(findsShopModule.mGiftCardBannerImage);
        if (findsShopModule.mCategories == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(findsShopModule.mCategories.size());
        for (FindsSearchCategory findsSearchCategory : findsShopModule.mCategories) {
    ...
    private void m2680xba85dc3d(Section section, Parcel parcel, int i) {
        if (section.mHeader == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2678xc1b17a35(section.mHeader, parcel, i);
        }
        if (section.mFooter == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2677xbedb4d43(section.mFooter, parcel, i);
        }
        ...
        for (FindsTwoTitledListingsModule.Listing listing : section.mListings) {
            if (listing == null) {
                ...
                parcel.writeInt(1);
                m2679x4fef17dc(listing, parcel, i);
            }
        }
    }

    private void m2678xc1b17a35(Header header, Parcel parcel, int i) {
    ...
    private void m2677xbedb4d43(Footer footer, Parcel parcel, int i) {
    ...
    private void m2679x4fef17dc(FindsTwoTitledListingsModule.Listing listing, Parcel parcel, int i) {
        int i2;
        int i3 = 0;
    ...
    public FindsShopModule getParcel() {
        return this.findsShopModule$$0;
    }
}
