...
/* renamed from: com.etsy.android.lib.models.finds.n */
final class FindsTwoTitledListingsModule$Section$$Parcelable implements Creator<FindsTwoTitledListingsModule$Section$$Parcelable> {
    private FindsTwoTitledListingsModule$Section$$Parcelable() {
    }
    ...
    public FindsTwoTitledListingsModule$Section$$Parcelable m2761a(Parcel parcel) {
        return new FindsTwoTitledListingsModule$Section$$Parcelable(parcel);
    }

    public FindsTwoTitledListingsModule$Section$$Parcelable[] m2762a(int i) {
        return new FindsTwoTitledListingsModule$Section$$Parcelable[i];
    }
}
droid.lib.models.ListingVideos;
...
public class FindsTwoTitledListingsModule$Section$$Parcelable implements android.os.Parcelable, ax<Section> {
    public static final FindsTwoTitledListingsModule$Section$$Parcelable CREATOR;
    private Section section$$36;

    static {
        CREATOR = new FindsTwoTitledListingsModule$Section$$Parcelable();
    }

    public FindsTwoTitledListingsModule$Section$$Parcelable(Parcel parcel) {
        Section section;
        if (parcel.readInt() == -1) {
            section = null;
        } else {
            section = m2712x9a940b4(parcel);
        }
        this.section$$36 = section;
    }

    public FindsTwoTitledListingsModule$Section$$Parcelable(Section section) {
        this.section$$36 = section;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.section$$36 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        m2716xba85dc3d(this.section$$36, parcel, i);
    }

    private Section m2712x9a940b4(Parcel parcel) {
        Header header;
        Footer footer;
        List list = null;
        ...
        if (parcel.readInt() == -1) {
            ...
            header = m2710x58e42ade(parcel);
        }
        section.mHeader = header;
        if (parcel.readInt() == -1) {
            footer = null;
        } else {
            footer = m2709x560dfdec(parcel);
        }
    ...
    private Header m2710x58e42ade(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
    ...
    private LocalStore readcom_etsy_android_lib_models_LocalStore(Parcel parcel) {
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
            }
    ...
    private LocalMarketCard readcom_etsy_android_lib_models_LocalMarketCard(Parcel parcel) {
        ...
        if (i >= 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                list2.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
            }
        }
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listingCard, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private Listing readcom_etsy_android_lib_models_Listing(Parcel parcel) {
        ...
        Listing$$PackageHelper.accessListing$FS$mMostRecentUpdate(listing, (ListingUpdate) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() == -1) {
            etsyMoney = null;
        } else {
            etsyMoney = readcom_etsy_android_lib_core_EtsyMoney(parcel);
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((ListingOption) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
            }
            obj = arrayList;
        }
        ...
        Listing$$PackageHelper.accessListing$FS$mFundOnEtsyCampaign(listing, (com.etsy.android.lib.models.FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
        i = parcel.readInt();
        if (i < 0) {
            list = null;
        } else {
    ...
    private Footer m2709x560dfdec(Parcel parcel) {
        FindsUrl findsUrl;
        List list;
        ArrayList arrayList;
        int i;
    ...
    private FindsTwoTitledListingsModule.Listing m2711x9f127c53(Parcel parcel) {
        boolean z;
        EtsyId etsyId;
        EtsyMoney etsyMoney;
        EtsyId etsyId2 = null;
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listing, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Section$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private void m2716xba85dc3d(Section section, Parcel parcel, int i) {
        if (section.mHeader == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2714xc1b17a35(section.mHeader, parcel, i);
        }
        if (section.mFooter == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2713xbedb4d43(section.mFooter, parcel, i);
        }
        ...
        for (FindsTwoTitledListingsModule.Listing listing : section.mListings) {
            if (listing == null) {
                ...
                parcel.writeInt(1);
                m2715x4fef17dc(listing, parcel, i);
            }
        }
    }

    private void m2714xc1b17a35(Header header, Parcel parcel, int i) {
        ...
        if (header.mSections == null) {
            ...
            for (Section section : header.mSections) {
                if (section == null) {
                    ...
                    parcel.writeInt(1);
                    m2716xba85dc3d(section, parcel, i);
                }
            }
        }
    ...
    private void m2713xbedb4d43(Footer footer, Parcel parcel, int i) {
    ...
    private void m2715x4fef17dc(FindsTwoTitledListingsModule.Listing listing, Parcel parcel, int i) {
        int i2;
        int i3 = 0;
