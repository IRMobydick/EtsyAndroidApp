...
public class FindsTwoTitledListingsModule$Footer$$Parcelable implements android.os.Parcelable, ax<Footer> {
    public static final FindsTwoTitledListingsModule$Footer$$Parcelable CREATOR;
    private Footer footer$$12;

    static {
        CREATOR = new FindsTwoTitledListingsModule$Footer$$Parcelable();
    }

    public FindsTwoTitledListingsModule$Footer$$Parcelable(Parcel parcel) {
        Footer footer;
        if (parcel.readInt() == -1) {
            footer = null;
        } else {
            footer = m2691x560dfdec(parcel);
        }
        this.footer$$12 = footer;
    }

    public FindsTwoTitledListingsModule$Footer$$Parcelable(Footer footer) {
        this.footer$$12 = footer;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.footer$$12 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        m2695xbedb4d43(this.footer$$12, parcel, i);
    }

    private Footer m2691x560dfdec(Parcel parcel) {
        FindsUrl findsUrl;
        List list;
        ArrayList arrayList;
        int i;
    ...
    private LocalStore readcom_etsy_android_lib_models_LocalStore(Parcel parcel) {
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
            }
    ...
    private LocalMarketCard readcom_etsy_android_lib_models_LocalMarketCard(Parcel parcel) {
        ...
        if (i >= 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                list2.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
            }
        }
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listingCard, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private Section m2694x9a940b4(Parcel parcel) {
        Header header;
        Footer footer;
        List list = null;
    ...
    private Header m2692x58e42ade(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
    ...
    private Listing readcom_etsy_android_lib_models_Listing(Parcel parcel) {
        ...
        Listing$$PackageHelper.accessListing$FS$mMostRecentUpdate(listing, (ListingUpdate) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() == -1) {
            etsyMoney = null;
        } else {
            etsyMoney = readcom_etsy_android_lib_core_EtsyMoney(parcel);
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((ListingOption) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
            }
            obj = arrayList;
        }
        ...
        Listing$$PackageHelper.accessListing$FS$mFundOnEtsyCampaign(listing, (com.etsy.android.lib.models.FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
        i = parcel.readInt();
        if (i < 0) {
            list = null;
        } else {
    ...
    private FindsTwoTitledListingsModule.Listing m2693x9f127c53(Parcel parcel) {
        boolean z;
        EtsyId etsyId;
        EtsyMoney etsyMoney;
        EtsyId etsyId2 = null;
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listing, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Footer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private void m2695xbedb4d43(Footer footer, Parcel parcel, int i) {
        ...
        if (footer.mSections == null) {
            ...
            for (Section section : footer.mSections) {
                if (section == null) {
                    ...
                    parcel.writeInt(1);
                    m2698xba85dc3d(section, parcel, i);
                }
            }
        }
    ...
    private void m2698xba85dc3d(Section section, Parcel parcel, int i) {
        if (section.mHeader == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2696xc1b17a35(section.mHeader, parcel, i);
        }
        if (section.mFooter == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2695xbedb4d43(section.mFooter, parcel, i);
        }
        ...
        for (FindsTwoTitledListingsModule.Listing listing : section.mListings) {
            if (listing == null) {
                ...
                parcel.writeInt(1);
                m2697x4fef17dc(listing, parcel, i);
            }
        }
    }

    private void m2696xc1b17a35(Header header, Parcel parcel, int i) {
    ...
    private void m2697x4fef17dc(FindsTwoTitledListingsModule.Listing listing, Parcel parcel, int i) {
        int i2;
        int i3 = 0;
    ...
    public Footer getParcel() {
        return this.footer$$12;
    }
}
