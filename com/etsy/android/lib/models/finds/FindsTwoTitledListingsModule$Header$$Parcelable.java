...
public class FindsTwoTitledListingsModule$Header$$Parcelable implements android.os.Parcelable, ax<Header> {
    public static final FindsTwoTitledListingsModule$Header$$Parcelable CREATOR;
    private Header header$$9;

    static {
        CREATOR = new FindsTwoTitledListingsModule$Header$$Parcelable();
    }

    public FindsTwoTitledListingsModule$Header$$Parcelable(Parcel parcel) {
        Header header;
        if (parcel.readInt() == -1) {
            header = null;
        } else {
            header = m2700x58e42ade(parcel);
        }
        this.header$$9 = header;
    }

    public FindsTwoTitledListingsModule$Header$$Parcelable(Header header) {
        this.header$$9 = header;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.header$$9 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        m2704xc1b17a35(this.header$$9, parcel, i);
    }

    private Header m2700x58e42ade(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
    ...
    private LocalStore readcom_etsy_android_lib_models_LocalStore(Parcel parcel) {
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
            }
    ...
    private LocalMarketCard readcom_etsy_android_lib_models_LocalMarketCard(Parcel parcel) {
        ...
        if (i >= 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                list2.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
            }
        }
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listingCard, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private Section m2702x9a940b4(Parcel parcel) {
        Header header;
        Footer footer;
        List list = null;
    ...
    private Footer m2699x560dfdec(Parcel parcel) {
        FindsUrl findsUrl;
        List list;
        ArrayList arrayList;
        int i;
    ...
    private Listing readcom_etsy_android_lib_models_Listing(Parcel parcel) {
        ...
        Listing$$PackageHelper.accessListing$FS$mMostRecentUpdate(listing, (ListingUpdate) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() == -1) {
            etsyMoney = null;
        } else {
            etsyMoney = readcom_etsy_android_lib_core_EtsyMoney(parcel);
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((ListingOption) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
            }
            obj = arrayList;
        }
        ...
        Listing$$PackageHelper.accessListing$FS$mFundOnEtsyCampaign(listing, (com.etsy.android.lib.models.FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
        i = parcel.readInt();
        if (i < 0) {
            list = null;
        } else {
    ...
    private FindsTwoTitledListingsModule.Listing m2701x9f127c53(Parcel parcel) {
        boolean z;
        EtsyId etsyId;
        EtsyMoney etsyMoney;
        EtsyId etsyId2 = null;
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listing, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Header$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private void m2704xc1b17a35(Header header, Parcel parcel, int i) {
        ...
        if (header.mSections == null) {
            ...
            for (Section section : header.mSections) {
                if (section == null) {
                    ...
                    parcel.writeInt(1);
                    m2706xba85dc3d(section, parcel, i);
                }
            }
        }
    ...
    private void m2706xba85dc3d(Section section, Parcel parcel, int i) {
        if (section.mHeader == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2704xc1b17a35(section.mHeader, parcel, i);
        }
        if (section.mFooter == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2703xbedb4d43(section.mFooter, parcel, i);
        }
        ...
        for (FindsTwoTitledListingsModule.Listing listing : section.mListings) {
            if (listing == null) {
                ...
                parcel.writeInt(1);
                m2705x4fef17dc(listing, parcel, i);
            }
        }
    }

    private void m2703xbedb4d43(Footer footer, Parcel parcel, int i) {
    ...
    private void m2705x4fef17dc(FindsTwoTitledListingsModule.Listing listing, Parcel parcel, int i) {
        int i2;
        int i3 = 0;
