...
import com.etsy.android.lib.models.finds.FindsTwoTitledListingsModule.Spacer;
...
public class FindsTwoTitledListingsModule$Spacer$$Parcelable implements android.os.Parcelable, ax<Spacer> {
    public static final FindsTwoTitledListingsModule$Spacer$$Parcelable CREATOR;
    private Spacer spacer$$0;

    static {
        CREATOR = new FindsTwoTitledListingsModule$Spacer$$Parcelable();
    }

    public FindsTwoTitledListingsModule$Spacer$$Parcelable(Parcel parcel) {
        Spacer spacer;
        if (parcel.readInt() == -1) {
            spacer = null;
        } else {
            spacer = m2721x6c44787d(parcel);
        }
        this.spacer$$0 = spacer;
    }

    public FindsTwoTitledListingsModule$Spacer$$Parcelable(Spacer spacer) {
        this.spacer$$0 = spacer;
    }

    public void writeToParcel(Parcel parcel, int i) {
        if (this.spacer$$0 == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(1);
        m2726xd511c7d4(this.spacer$$0, parcel, i);
    }

    private Spacer m2721x6c44787d(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
        ...
        spacer.mPages = list;
        spacer.mType = parcel.readString();
        ...
        spacer.mShops = list;
        spacer.mText = parcel.readString();
        spacer.mCta = parcel.readString();
        spacer.mTitle = parcel.readString();
        readInt = parcel.readInt();
        if (readInt < 0) {
            list = null;
        } else {
        ...
        if (readInt < 0) {
            ...
            for (i = 0; i < readInt; i++) {
                if (parcel.readInt() == -1) {
                    ...
                    obj = m2720x9a940b4(parcel);
                }
                arrayList.add(obj);
            }
            obj = arrayList;
        }
        spacer.mSections = list;
        spacer.mGiftCardBannerImage = (GiftCardBannerImage) parcel.readSerializable();
        i = parcel.readInt();
        if (i >= 0) {
            arrayList = new ArrayList();
            while (i2 < i) {
    ...
    private LocalStore readcom_etsy_android_lib_models_LocalStore(Parcel parcel) {
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
            }
    ...
    private LocalMarketCard readcom_etsy_android_lib_models_LocalMarketCard(Parcel parcel) {
        ...
        if (i >= 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                list2.add((LocalStoreImage) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
            }
        }
    ...
    private ListingCard readcom_etsy_android_lib_models_apiv3_ListingCard(Parcel parcel) {
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listingCard, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private Section m2720x9a940b4(Parcel parcel) {
        Header header;
        Footer footer;
        List list = null;
        ...
        if (parcel.readInt() == -1) {
            ...
            header = m2718x58e42ade(parcel);
        }
        section.mHeader = header;
        if (parcel.readInt() == -1) {
            footer = null;
        } else {
            footer = m2717x560dfdec(parcel);
        }
    ...
    private Header m2718x58e42ade(Parcel parcel) {
        List list;
        ArrayList arrayList;
        int i;
        Object obj;
    ...
    private Listing readcom_etsy_android_lib_models_Listing(Parcel parcel) {
        ...
        Listing$$PackageHelper.accessListing$FS$mMostRecentUpdate(listing, (ListingUpdate) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() == -1) {
            etsyMoney = null;
        } else {
            etsyMoney = readcom_etsy_android_lib_core_EtsyMoney(parcel);
        ...
        if (readInt < 0) {
            ...
            arrayList = new ArrayList();
            for (i = 0; i < readInt; i++) {
                arrayList.add((ListingOption) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
            }
            obj = arrayList;
        }
        ...
        Listing$$PackageHelper.accessListing$FS$mFundOnEtsyCampaign(listing, (com.etsy.android.lib.models.FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
        i = parcel.readInt();
        if (i < 0) {
            list = null;
        } else {
    ...
    private Footer m2717x560dfdec(Parcel parcel) {
        FindsUrl findsUrl;
        List list;
        ArrayList arrayList;
        int i;
    ...
    private FindsTwoTitledListingsModule.Listing m2719x9f127c53(Parcel parcel) {
        boolean z;
        EtsyId etsyId;
        EtsyMoney etsyMoney;
        EtsyId etsyId2 = null;
        ...
        ListingCard$$PackageHelper.accessListingCard$FS$mFundOnEtsyCampaign(listing, (FundOnEtsyCampaign) parcel.readParcelable(FindsTwoTitledListingsModule$Spacer$$Parcelable.class.getClassLoader()));
        if (parcel.readInt() != -1) {
            etsyId2 = readcom_etsy_android_lib_models_datatypes_EtsyId(parcel);
        }
    ...
    private void m2726xd511c7d4(Spacer spacer, Parcel parcel, int i) {
        if (spacer.mPages == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(spacer.mPages.size());
            for (Page page : spacer.mPages) {
                if (page == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        parcel.writeString(spacer.mType);
        if (spacer.mShops == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(spacer.mShops.size());
            for (ShopCard shopCard : spacer.mShops) {
                if (shopCard == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        parcel.writeString(spacer.mText);
        parcel.writeString(spacer.mCta);
        parcel.writeString(spacer.mTitle);
        if (spacer.mListings == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(spacer.mListings.size());
            for (ListingCard listingCard : spacer.mListings) {
                if (listingCard == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
        ...
        if (spacer.mSections == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(spacer.mSections.size());
            for (Section section : spacer.mSections) {
                if (section == null) {
                    parcel.writeInt(-1);
                } else {
                    parcel.writeInt(1);
                    m2725xba85dc3d(section, parcel, i);
                }
            }
        }
        parcel.writeSerializable(spacer.mGiftCardBannerImage);
        if (spacer.mCategories == null) {
            parcel.writeInt(-1);
            return;
        }
        parcel.writeInt(spacer.mCategories.size());
        for (FindsSearchCategory findsSearchCategory : spacer.mCategories) {
    ...
    private void m2725xba85dc3d(Section section, Parcel parcel, int i) {
        if (section.mHeader == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2723xc1b17a35(section.mHeader, parcel, i);
        }
        if (section.mFooter == null) {
            parcel.writeInt(-1);
        } else {
            parcel.writeInt(1);
            m2722xbedb4d43(section.mFooter, parcel, i);
        }
        ...
        for (FindsTwoTitledListingsModule.Listing listing : section.mListings) {
            if (listing == null) {
                ...
                parcel.writeInt(1);
                m2724x4fef17dc(listing, parcel, i);
            }
        }
    }

    private void m2723xc1b17a35(Header header, Parcel parcel, int i) {
    ...
    private void m2722xbedb4d43(Footer footer, Parcel parcel, int i) {
    ...
    private void m2724x4fef17dc(FindsTwoTitledListingsModule.Listing listing, Parcel parcel, int i) {
        int i2;
        int i3 = 0;
    ...
    public Spacer getParcel() {
        return this.spacer$$0;
    }
}
