...
public abstract class TrackingBaseDialogFragment extends BaseDialogFragment implements ITrackingView {
    private TrackingFragmentDelegate mTrackingDelegate;

    public TrackingBaseDialogFragment() {
    ...
    @VisibleForTesting
    public void setViewAnalyticsTracker(ad adVar) {
        this.mTrackingDelegate.m5431a(adVar);
    }
}
