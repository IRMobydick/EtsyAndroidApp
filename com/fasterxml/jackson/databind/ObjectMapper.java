...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public ObjectMapper registerModule(Module module) {
        if (module.getModuleName() == null) {
            ...
            module.setupModule(new 1(this, this));
            return this;
        }
    }
    ...
    public <T> T readValue(JsonParser jsonParser, Class<T> cls) {
        return _readValue(getDeserializationConfig(), jsonParser, this._typeFactory.constructType(cls));
    }
    ...
    public <T> T readValue(URL url, Class<T> cls) {
        return _readMapAndClose(this._jsonFactory.createParser(url), this._typeFactory.constructType(cls));
    }
    ...
    public <T> T readValue(Reader reader, Class<T> cls) {
        return _readMapAndClose(this._jsonFactory.createParser(reader), this._typeFactory.constructType(cls));
    }
    ...
    public <T> T readValue(InputStream inputStream, Class<T> cls) {
        return _readMapAndClose(this._jsonFactory.createParser(inputStream), this._typeFactory.constructType(cls));
    }
    ...
    public <T> T readValue(byte[] bArr, int i, int i2, Class<T> cls) {
        return _readMapAndClose(this._jsonFactory.createParser(bArr, i, i2), this._typeFactory.constructType(cls));
    }
