...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public static final ConnectionResult zzakj;
    ...
    static {
        zzakj = new ConnectionResult(SUCCESS);
        CREATOR = new zzb();
    }
    ...
    public int hashCode() {
        ...
        objArr[SUCCESS] = Integer.valueOf(this.zzahG);
        objArr[SERVICE_MISSING] = this.mPendingIntent;
        objArr[SERVICE_VERSION_UPDATE_REQUIRED] = this.zzakk;
        return zzz.hashCode(objArr);
    }
    ...
    public String toString() {
        return zzz.zzy(this).zzg("statusCode", getStatusString(this.zzahG)).zzg("resolution", this.mPendingIntent).zzg(ResponseConstants.TRANSLATED_CONVERSATION_MESSAGE, this.zzakk).toString();
    }
