...
public class gg extends gd {
    private static final Set<String> f4949d;
    private static final DecimalFormat f4950e;
    private File f4951f;
    private boolean f4952g;

    static {
        f4949d = Collections.synchronizedSet(new HashSet());
        f4950e = new DecimalFormat("#,###");
    }
    ...
    public gg(no noVar) {
        ...
        if (cacheDir == null) {
            C1129c.m6192d("Context.getCacheDir() returned null");
            return;
        }
        this.f4951f = new File(cacheDir, "admobVideoStreams");
        String str;
        String valueOf;
        if (!this.f4951f.isDirectory() && !this.f4951f.mkdirs()) {
            str = "Could not create preload cache directory at ";
            valueOf = String.valueOf(this.f4951f.getAbsolutePath());
            C1129c.m6192d(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
            this.f4951f = null;
        } else if (!this.f4951f.setReadable(true, false) || !this.f4951f.setExecutable(true, false)) {
    ...
    private File m6575a(File file) {
        return new File(this.f4951f, String.valueOf(file.getName()).concat(".done"));
    }

    private static void m6576b(File file) {
        if (file.isFile()) {
    ...
    public boolean m6578a(java.lang.String r27) {
        /*
        r26 = this;
        r0 = r26;
        r2 = r0.f4951f;
    ...
    L_0x0006:
        ...
        r0 = r26;
        r1 = r27;
        r0.m6571a(r1, r2, r3, r4);
        r2 = 0;
    L_0x0012:
        return r2;
    L_0x0013:
        r3 = r26.m6579b();
        r2 = com.google.android.gms.internal.dz.f4842p;
        r2 = r2.m6433c();
    ...
    L_0x006d:
        r2 = r4.concat(r2);
    L_0x0071:
        com.google.android.gms.ads.internal.util.client.C1129c.m6185a(r2);
    ...
    L_0x00bd:
        com.google.android.gms.ads.internal.util.client.C1129c.m6192d(r2);	 Catch:{ all -> 0x00d2 }
        r2 = r12.getAbsolutePath();	 Catch:{ all -> 0x00d2 }
        r4 = "inProgress";
        r5 = 0;
        r0 = r26;
        r1 = r27;
        r0.m6571a(r1, r2, r4, r5);	 Catch:{ all -> 0x00d2 }
        r2 = 0;
    ...
    L_0x00e2:
        ...
        r2 = com.google.android.gms.internal.dz.f4847u;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r2.m6433c();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0163:
        r6 = com.google.android.gms.ads.internal.C1101o.m6044h();
        r7 = 1;
        r6.m7021a(r2, r7);
    L_0x016b:
    ...
    L_0x0174:
        ...
        r2 = r2.append(r5);
        r2 = r2.toString();
        com.google.android.gms.ads.internal.util.client.C1129c.m6190c(r2);
    L_0x019c:
        r2 = r12.exists();
    ...
    L_0x01f2:
        com.google.android.gms.ads.internal.util.client.C1129c.m6192d(r2);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r12.getAbsolutePath();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r3 = "contentLengthMissing";
        r4 = 0;
        r0 = r26;
        r1 = r27;
        r0.m6571a(r1, r2, r3, r4);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = f4949d;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0211:
        ...
        goto L_0x015f;
    L_0x0216:
        r2 = f4950e;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        ...
        r2 = com.google.android.gms.internal.dz.f4843q;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r2.m6433c();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = (java.lang.Integer) r2;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0270:
        ...
        r0 = r26;
        r1 = r27;
        r0.m6571a(r1, r3, r4, r2);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = f4949d;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2.remove(r8);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = 0;
        goto L_0x0012;
    ...
    L_0x0290:
        ...
        r2 = r2.append(r0);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r2.toString();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        com.google.android.gms.ads.internal.util.client.C1129c.m6185a(r2);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        ...
        r18 = com.google.android.gms.ads.internal.C1101o.m6045i();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r5 = 0;
        r20 = r18.currentTimeMillis();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = com.google.android.gms.internal.dz.f4846t;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = r2.m6433c();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        ...
        r19 = new com.google.android.gms.internal.mr;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r0 = r19;
        r0.<init>(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = com.google.android.gms.internal.dz.f4845s;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = r2.m6433c();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = (java.lang.Long) r2;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x038f:
        r0 = r26;
        r2 = r0.f4952g;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x039f:
        ...
        goto L_0x015f;
    L_0x03a4:
        r2 = r19.m7188a();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x03aa:
        ...
        r2 = r26;
        r3 = r27;
        r2.m6570a(r3, r4, r5, r6, r7);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        goto L_0x0304;
    L_0x03b8:
        r2 = move-exception;
        r3 = r9;
    ...
    L_0x03be:
        ...
        r2 = 3;
        r2 = com.google.android.gms.ads.internal.util.client.C1129c.m6187a(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        if (r2 == 0) goto L_0x0404;
    L_0x03c8:
        r2 = f4950e;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        ...
        com.google.android.gms.ads.internal.util.client.C1129c.m6185a(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    L_0x0404:
        r2 = 1;
        r3 = 0;
        r12.setReadable(r2, r3);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        m6576b(r13);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = r12.getAbsolutePath();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r0 = r26;
        r1 = r27;
        r0.m6569a(r1, r2, r5);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = f4949d;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x041f:
        ...
        r5 = r5.append(r6);
        r5 = r5.toString();
        com.google.android.gms.ads.internal.util.client.C1129c.m6193d(r5, r2);
        goto L_0x019c;
    L_0x0449:
        r2 = new java.lang.String;
        r2.<init>(r5);
    ...
    L_0x045d:
        ...
        goto L_0x015f;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.gg.a(java.lang.String):boolean");
    }

    public int m6579b() {
        int i = 0;
        if (this.f4951f != null) {
            for (File name : this.f4951f.listFiles()) {
    ...
    public boolean m6580c() {
        ...
        File[] listFiles = this.f4951f.listFiles();
