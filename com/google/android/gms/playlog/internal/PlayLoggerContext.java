...
public class PlayLoggerContext extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        return zzz.hashCode(new Object[]{Integer.valueOf(this.versionCode), this.packageName, Integer.valueOf(this.zzbkZ), Integer.valueOf(this.zzbla), this.zzble, this.zzblb, this.zzblc, Boolean.valueOf(this.zzbld), Boolean.valueOf(this.zzblf), Integer.valueOf(this.zzblg)});
    }
