...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    class NavigationMenuAdapter extends Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            switch (getItemViewType(i)) {
                case VIEW_TYPE_NORMAL /*0*/:
                    ...
                    navigationMenuItemView.initialize(((NavigationMenuTextItem) this.mItems.get(i)).getMenuItem(), VIEW_TYPE_NORMAL);
                case VIEW_TYPE_SUBHEADER /*1*/:
                ...
                case VIEW_TYPE_SEPARATOR /*2*/:
                    ...
                    viewHolder.itemView.setPadding(VIEW_TYPE_NORMAL, navigationMenuSeparatorItem.getPaddingTop(), VIEW_TYPE_NORMAL, navigationMenuSeparatorItem.getPaddingBottom());
                default:
            }
        }
                ...
                while (i3 < size) {
                    ...
                    if (menuItemImpl.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            this.mItems.add(new NavigationMenuTextItem(null));
                            Object obj3 = null;
                            int size2 = this.mItems.size();
                            int size3 = subMenu.size();
                            for (i6 = VIEW_TYPE_NORMAL; i6 < size3; i6 += VIEW_TYPE_SUBHEADER) {
                                MenuItemImpl menuItemImpl2 = (MenuItemImpl) subMenu.getItem(i6);
                                if (menuItemImpl2.isVisible()) {
                                    if (obj3 == null && menuItemImpl2.getIcon() != null) {
                                        obj3 = VIEW_TYPE_SUBHEADER;
                                    }
                        ...
                        if (i6 != i) {
                            i2 = this.mItems.size();
                            obj = menuItemImpl.getIcon() != null ? VIEW_TYPE_SUBHEADER : null;
                            if (i3 != 0) {
                                i2 += VIEW_TYPE_SUBHEADER;
            ...
            while (i < i2) {
                ...
                if (menuItem.getIcon() == null) {
                    if (this.mTransparentIcon == null) {
                        this.mTransparentIcon = new ColorDrawable(VIEW_TYPE_NORMAL);
                    }
                    menuItem.setIcon(this.mTransparentIcon);
                }
                i += VIEW_TYPE_SUBHEADER;
            }
        }
        ...
        public void restoreInstanceState(Bundle bundle) {
            ...
            int i = bundle.getInt(STATE_CHECKED_ITEM, VIEW_TYPE_NORMAL);
            if (i != 0) {
                this.mUpdateSuspended = true;
                Iterator it = this.mItems.iterator();
                while (it.hasNext()) {
    ...
    class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0000R.layout.design_navigation_item, viewGroup, false));
    ...
    class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0000R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0000R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }

    public NavigationMenuPresenter() {
        this.mOnClickListener = new C00011();
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            this.mMenuView = (NavigationMenuView) this.mLayoutInflater.inflate(C0000R.layout.design_navigation_menu, viewGroup, false);
