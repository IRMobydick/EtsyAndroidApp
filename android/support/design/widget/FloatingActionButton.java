...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class C00151 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C00151(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        class C00161 implements AnimatorUpdateListener {
            final /* synthetic */ FloatingActionButton val$fab;

            C00161(FloatingActionButton floatingActionButton) {
            ...
            if (this.mFabTranslationY != fabTranslationYForSnackbar) {
                ...
                if (!floatingActionButton.isShown() || Math.abs(translationY - fabTranslationYForSnackbar) <= ((float) floatingActionButton.getHeight()) * 0.667f) {
                    ...
                    if (this.mFabTranslationYAnimator == null) {
                        ...
                        this.mFabTranslationYAnimator.setUpdateListener(new C00161(floatingActionButton));
                    }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.FloatingActionButton, i, C0000R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = obtainStyledAttributes.getColorStateList(C0000R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = parseTintMode(obtainStyledAttributes.getInt(C0000R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = obtainStyledAttributes.getColor(C0000R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = obtainStyledAttributes.getInt(C0000R.styleable.FloatingActionButton_fabSize, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C0000R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = obtainStyledAttributes.getDimension(C0000R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = obtainStyledAttributes.getDimension(C0000R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = obtainStyledAttributes.getBoolean(C0000R.styleable.FloatingActionButton_useCompatPadding, false);
    ...
    private InternalVisibilityChangedListener wrapOnVisibilityChangedListener(@Nullable OnVisibilityChangedListener onVisibilityChangedListener) {
        ...
        return new C00151(onVisibilityChangedListener);
    }
