...
class FloatingActionButtonEclairMr1 extends FloatingActionButtonImpl {
    ...
    class C00171 extends AnimationListenerAdapter {
        final /* synthetic */ boolean val$fromUser;
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C00171(boolean z, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$fromUser = z;
    ...
    class C00182 extends AnimationListenerAdapter {
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C00182(InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$listener = internalVisibilityChangedListener;
        }
    ...
    void hide(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        if (!this.mIsHiding && this.mView.getVisibility() == 0) {
            Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0000R.anim.design_fab_out);
            loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR);
            loadAnimation.setDuration(200);
            loadAnimation.setAnimationListener(new C00171(z, internalVisibilityChangedListener));
    ...
    void show(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        if (this.mView.getVisibility() != 0 || this.mIsHiding) {
            ...
            Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0000R.anim.design_fab_in);
            loadAnimation.setDuration(200);
            loadAnimation.setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
            loadAnimation.setAnimationListener(new C00182(internalVisibilityChangedListener));
            this.mView.startAnimation(loadAnimation);
        } else if (internalVisibilityChangedListener != null) {
