...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00131 implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return ((LayoutParams) view2.getLayoutParams()).dependsOn(CoordinatorLayout.this, view2, view) ? -1 : CoordinatorLayout.TYPE_ON_INTERCEPT;
        }
    }

    class ApplyInsetsListener implements OnApplyWindowInsetsListener {
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.mAnchorId = -1;
            this.mLastChildRect = new Rect();
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = obtainStyledAttributes.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.keyline = obtainStyledAttributes.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
    ...
    public class SavedState extends BaseSavedState {
        ...
        final class C00141 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00141() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00141());
        }
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.CoordinatorLayout, i, C0000R.style.Widget_Design_CoordinatorLayout);
        int resourceId = obtainStyledAttributes.getResourceId(C0000R.styleable.CoordinatorLayout_keylines, TYPE_ON_INTERCEPT);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0000R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        ...
        while (i5 < size3) {
            ...
            if (layoutParams.keyline >= 0 && mode != 0) {
                ...
                if ((paddingTop == 3 && r9 == null) || (paddingTop == 5 && r9 != null)) {
                    i10 = Math.max(TYPE_ON_INTERCEPT, (size - paddingRight) - keyline);
                } else if ((paddingTop == 5 && r9 == null) || (paddingTop == 3 && r9 != null)) {
                    i10 = Math.max(TYPE_ON_INTERCEPT, keyline - paddingLeft);
                }
            }
            ...
            Behavior behavior = layoutParams.getBehavior();
            if (behavior == null || !behavior.onMeasureChild(this, view, suggestedMinimumWidth, i10, i9, TYPE_ON_INTERCEPT)) {
                onMeasureChild(view, suggestedMinimumWidth, i10, i9, TYPE_ON_INTERCEPT);
            }
    ...
    void getChildRect(View view, boolean z, Rect rect) {
        if (view.isLayoutRequested() || view.getVisibility() == 8) {
            rect.set(TYPE_ON_INTERCEPT, TYPE_ON_INTERCEPT, TYPE_ON_INTERCEPT, TYPE_ON_INTERCEPT);
        } else if (z) {
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        switch (i4) {
            case CommonStatusCodes.CANCELED /*16*/:
                absoluteGravity = TYPE_ON_INTERCEPT + (measuredHeight / 2);
                break;
            case R.AppCompatTheme_panelMenuListTheme /*80*/:
    ...
    void dispatchOnDependentViewChanged(boolean z) {
        int layoutDirection = ViewCompat.getLayoutDirection(this);
        int size = this.mDependencySortedChildren.size();
        for (int i = TYPE_ON_INTERCEPT; i < size; i += TYPE_ON_TOUCH) {
            int i2;
            View view = (View) this.mDependencySortedChildren.get(i);
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            for (i2 = TYPE_ON_INTERCEPT; i2 < i; i2 += TYPE_ON_TOUCH) {
            ...
            if (!rect.equals(rect2)) {
                ...
                for (i2 = i + TYPE_ON_TOUCH; i2 < size; i2 += TYPE_ON_TOUCH) {
        ...
        while (i5 < childCount) {
            ...
            if (layoutParams.isNestedScrollAccepted()) {
                ...
                if (behavior != null) {
                    ...
                    max = i > 0 ? Math.max(i3, this.mTempIntPair[TYPE_ON_INTERCEPT]) : Math.min(i3, this.mTempIntPair[TYPE_ON_INTERCEPT]);
                    max2 = i2 > 0 ? Math.max(i4, this.mTempIntPair[TYPE_ON_TOUCH]) : Math.min(i4, this.mTempIntPair[TYPE_ON_TOUCH]);
                    int i6 = TYPE_ON_TOUCH;
                } else {
                    obj2 = obj;
                    max = i3;
                    max2 = i4;
    ...
    private static void selectionSort(List<View> list, Comparator<View> comparator) {
        if (list != null && list.size() >= 2) {
            ...
            for (int i2 = TYPE_ON_INTERCEPT; i2 < length; i2 += TYPE_ON_TOUCH) {
                i = i2;
                for (int i3 = i2 + TYPE_ON_TOUCH; i3 < length; i3 += TYPE_ON_TOUCH) {
            ...
            list.clear();
            for (i = TYPE_ON_INTERCEPT; i < length; i += TYPE_ON_TOUCH) {
                list.add(viewArr[i]);
            }
        }
    }
