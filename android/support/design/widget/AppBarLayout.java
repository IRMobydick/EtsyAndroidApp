...
public class AppBarLayout extends LinearLayout {
    ...
    public class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C00051 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C00051(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        public class SavedState extends BaseSavedState {
            ...
            final class C00061 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C00061() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C00061());
            }
        }
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (topBottomOffsetForScrollingSibling != i) {
                if (this.mAnimator == null) {
                    ...
                    this.mAnimator.setUpdateListener(new C00051(coordinatorLayout, appBarLayout));
                } else {
                    this.mAnimator.cancel();
                }
    ...
    public class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.AppBarLayout_LayoutParams);
            this.mScrollFlags = obtainStyledAttributes.getInt(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator, 0));
            }
    ...
    public class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.ScrollingViewBehavior_Params);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0000R.styleable.ScrollingViewBehavior_Params_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
        ...
        float getOverlapRatioForOffset(View view) {
            ...
            if (totalScrollRange != 0) {
                return FullImageView.ASPECT_RATIO_SQUARE + (((float) appBarLayoutOffset) / ((float) totalScrollRange));
            }
            return 0.0f;
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0000R.styleable.AppBarLayout, 0, C0000R.style.Widget_Design_AppBarLayout);
        this.mTargetElevation = (float) obtainStyledAttributes.getDimensionPixelSize(C0000R.styleable.AppBarLayout_elevation, 0);
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0000R.styleable.AppBarLayout_android_background));
        if (obtainStyledAttributes.hasValue(C0000R.styleable.AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C0000R.styleable.AppBarLayout_expanded, false));
        }
        obtainStyledAttributes.recycle();
