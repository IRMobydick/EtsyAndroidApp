...
class SnackbarManager {
    ...
    class C00341 implements android.os.Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case SnackbarManager.MSG_TIMEOUT /*0*/:
    ...
    private SnackbarManager() {
        ...
        this.mHandler = new Handler(Looper.getMainLooper(), new C00341());
    }
    ...
    private void scheduleTimeoutLocked(SnackbarRecord snackbarRecord) {
        if (snackbarRecord.duration != -2) {
            ...
            this.mHandler.removeCallbacksAndMessages(snackbarRecord);
            this.mHandler.sendMessageDelayed(Message.obtain(this.mHandler, MSG_TIMEOUT, snackbarRecord), (long) i);
        }
    }
