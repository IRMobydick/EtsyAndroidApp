...
class ValueAnimatorCompatImplHoneycombMr1 extends Impl {
    ...
    class C00481 implements AnimatorUpdateListener {
        final /* synthetic */ AnimatorUpdateListenerProxy val$updateListener;

        C00481(AnimatorUpdateListenerProxy animatorUpdateListenerProxy) {
    ...
    class C00492 extends AnimatorListenerAdapter {
        ...
        C00492(AnimatorListenerProxy animatorListenerProxy) {
    ...
    public void setUpdateListener(AnimatorUpdateListenerProxy animatorUpdateListenerProxy) {
        this.mValueAnimator.addUpdateListener(new C00481(animatorUpdateListenerProxy));
    }

    public void setListener(AnimatorListenerProxy animatorListenerProxy) {
        this.mValueAnimator.addListener(new C00492(animatorListenerProxy));
    }
