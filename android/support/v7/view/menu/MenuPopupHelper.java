...
public class MenuPopupHelper implements MenuPresenter, OnKeyListener, OnGlobalLayoutListener, OnItemClickListener, OnDismissListener {
    ...
    class MenuAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            itemView.initialize(getItem(i), MenuPopupHelper.ITEM_LAYOUT);
            return inflate;
        }
    ...
    static {
        ITEM_LAYOUT = C0234R.layout.abc_popup_menu_item_layout;
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0234R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0234R.attr.popupMenuStyle);
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int i, int i2) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0234R.dimen.abc_config_prefDialogWidth));
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        menuAdapter.mAdapterMenu.performItemAction(menuAdapter.getItem(i), ITEM_LAYOUT);
    }
