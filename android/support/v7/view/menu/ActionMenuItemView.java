...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener, OnLongClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAllowTextWithIcon = resources.getBoolean(C0234R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0234R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0234R.bool.abc_config_allowActionMenuItemTextWithIcon);
