...
class ToolbarActionBar extends ActionBar {
    ...
    class C02292 implements OnMenuItemClickListener {
        C02292() {
        }
    ...
    final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
            return true;
        }
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(R.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
                }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Callback callback) {
        ...
        this.mMenuInvalidator = new C02281();
        this.mMenuClicker = new C02292();
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(contextThemeWrapper, C0234R.layout.abc_list_menu_item_layout);
