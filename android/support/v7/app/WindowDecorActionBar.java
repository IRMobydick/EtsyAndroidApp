...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02311 extends ViewPropertyAnimatorListenerAdapter {
        C02311() {
        }
    ...
    class C02322 extends ViewPropertyAnimatorListenerAdapter {
        C02322() {
        }
    ...
    class C02333 implements ViewPropertyAnimatorUpdateListener {
        C02333() {
        }
    ...
    public class TabImpl extends Tab {
        ...
        public Tab setIcon(int i) {
            return setIcon(AppCompatDrawableManager.get().getDrawable(WindowDecorActionBar.this.mContext, i));
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean z) {
        ...
        this.mHideListener = new C02311();
        this.mShowListener = new C02322();
        this.mUpdateListener = new C02333();
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0234R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0234R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0234R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0234R.id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0234R.styleable.ActionBar, C0234R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0234R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.ActionBar_elevation, 0);
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || z)) {
            ...
            ViewCompat.setAlpha(this.mContainerView, FullImageView.ASPECT_RATIO_SQUARE);
            ViewCompat.setTranslationY(this.mContainerView, 0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0234R.attr.actionBarWidgetTheme, typedValue, true);
