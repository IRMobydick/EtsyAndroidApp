...
public abstract class ActionBar {
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0234R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0234R.styleable.ActionBarLayout_android_layout_gravity, ActionBar.NAVIGATION_MODE_STANDARD);
