...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public class Builder {
        ...
        public Builder setView(View view) {
            this.f6P.mView = view;
            this.f6P.mViewLayoutResId = AlertDialog.LAYOUT_HINT_NONE;
            this.f6P.mViewSpacingSpecified = false;
            return this;
        }
        ...
        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f6P.mContext, this.mTheme, false);
    ...
    static int resolveDialogTheme(Context context, int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0234R.attr.alertDialogTheme, typedValue, true);
