...
class AlertController {
    ...
    class C02092 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02092(View view, View view2) {
            this.val$top = view;
    ...
    class C02114 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02114(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public class AlertParams {
        ...
        class C02131 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C02131(Context context, int i, int i2, CharSequence[] charSequenceArr, ListView listView) {
        ...
        class C02142 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02142(Context context, Cursor cursor, boolean z, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C02153 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C02153(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C02164 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02164(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (this.mIsSingleChoice) {
                    access$1300 = alertController.mSingleChoiceItemLayout;
                } else {
                    access$1300 = alertController.mListItemLayout;
                }
                if (this.mCursor != null) {
                    simpleCursorAdapter = new SimpleCursorAdapter(this.mContext, access$1300, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
                } else if (this.mAdapter != null) {
                    simpleCursorAdapter = this.mAdapter;
                } else {
                    simpleCursorAdapter = new CheckedItemAdapter(this.mContext, access$1300, 16908308, this.mItems);
                }
            } else if (this.mCursor == null) {
                simpleCursorAdapter = new C02131(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                Object c02142 = new C02142(this.mContext, this.mCursor, false, listView, alertController);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C02153(alertController));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C02164(listView, alertController));
            }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        this.mButtonHandler = new C02081();
        this.mContext = context;
        this.mDialog = appCompatDialog;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(appCompatDialog);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0234R.styleable.AlertDialog, C0234R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.AlertDialog_listItemLayout, 0);
    ...
    private void setupView() {
        boolean z;
        boolean z2;
        View findViewById = this.mWindow.findViewById(C0234R.id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0234R.id.topPanel);
        View findViewById3 = findViewById.findViewById(C0234R.id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0234R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0234R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0234R.id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0234R.id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0234R.id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById3 = resolvePanel2.findViewById(C0234R.id.textSpacerNoButtons);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2 = null;
        View findViewById = this.mWindow.findViewById(C0234R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0234R.id.scrollIndicatorDown);
        ...
        if (findViewById != null || view2 != null) {
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C02092(findViewById, view2));
                this.mScrollView.post(new C02103(findViewById, view2));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C02114(findViewById, view2));
                this.mListView.post(new C02125(findViewById, view2));
            } else {
                if (findViewById != null) {
                    viewGroup.removeView(findViewById);
                }
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0234R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0234R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((!TextUtils.isEmpty(this.mTitle) ? 1 : 0) != 0) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0234R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0234R.id.scrollView);
