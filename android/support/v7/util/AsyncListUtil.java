...
public class AsyncListUtil<T> {
    ...
    class C02381 implements MainThreadCallback<T> {
        C02381() {
        }
    ...
    class C02392 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> cls, int i, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02381();
        this.mBackgroundCallback = new C02392();
        this.mTClass = cls;
        this.mTileSize = i;
