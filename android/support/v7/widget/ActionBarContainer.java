...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        this.mBackground = obtainStyledAttributes.getDrawable(C0234R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0234R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.ActionBar_height, -1);
        if (getId() == C0234R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0234R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0234R.id.action_bar);
        this.mContextView = findViewById(C0234R.id.action_context_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        if (this.mActionBarView == null && MeasureSpec.getMode(i2) == RtlSpacingHelper.UNDEFINED && this.mHeight >= 0) {
            i2 = MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, MeasureSpec.getSize(i2)), RtlSpacingHelper.UNDEFINED);
        }
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                if (!isCollapsed(this.mActionBarView)) {
                    ...
                    measuredHeightWithMargins = getMeasuredHeightWithMargins(this.mContextView);
                }
                setMeasuredDimension(getMeasuredWidth(), Math.min(measuredHeightWithMargins + getMeasuredHeightWithMargins(this.mTabContainer), mode == RtlSpacingHelper.UNDEFINED ? MeasureSpec.getSize(i2) : MeasureConfiguration.DISABLED));
            }
        }
    }
