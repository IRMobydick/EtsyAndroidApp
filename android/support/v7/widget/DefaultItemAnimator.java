...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class C02714 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02714(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02725 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02725(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
            super();
        }
    ...
    class C02736 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ int val$deltaX;
        final /* synthetic */ int val$deltaY;
        final /* synthetic */ ViewHolder val$holder;

        C02736(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    class C02747 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ ViewPropertyAnimatorCompat val$oldViewAnim;

        C02747(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02758 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ View val$newView;
        final /* synthetic */ ViewPropertyAnimatorCompat val$newViewAnimation;

        C02758(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view) {
            this.val$changeInfo = changeInfo;
        ...
        public void onAnimationEnd(View view) {
            ...
            ViewCompat.setAlpha(this.val$newView, FullImageView.ASPECT_RATIO_SQUARE);
    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            if (i != 0) {
                ...
                c02681 = new C02681(arrayList);
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c02681, getRemoveDuration());
                } else {
                    c02681.run();
                }
            }
            if (i2 != 0) {
                ...
                c02681 = new C02692(arrayList);
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c02681, getRemoveDuration());
                } else {
                    c02681.run();
                }
            }
            if (i3 != 0) {
                ...
                Runnable c02703 = new C02703(arrayList2);
                if (i4 == 0 && i == 0 && i2 == 0) {
                    c02703.run();
                    return;
                }
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c02703, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
    ...
    private void animateRemoveImpl(ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new C02714(viewHolder, animate)).start();
    }
    ...
    private void animateAddImpl(ViewHolder viewHolder) {
        ...
        animate.alpha(FullImageView.ASPECT_RATIO_SQUARE).setDuration(getAddDuration()).setListener(new C02725(viewHolder, animate)).start();
    }
    ...
    private void animateMoveImpl(ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new C02736(viewHolder, i5, i6, animate)).start();
    }
    ...
    private void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new C02747(changeInfo, duration)).start();
        }
        if (view != null) {
            duration = ViewCompat.animate(view);
            this.mChangeAnimations.add(changeInfo.newHolder);
            duration.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(FullImageView.ASPECT_RATIO_SQUARE).setListener(new C02758(changeInfo, duration, view)).start();
        }
    }
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder viewHolder) {
        ...
        ViewCompat.setAlpha(viewHolder.itemView, FullImageView.ASPECT_RATIO_SQUARE);
        ...
        if (isRunning()) {
            ...
            for (size2 = this.mAdditionsList.size() - 1; size2 >= 0; size2--) {
                ...
                for (size3 = arrayList.size() - 1; size3 >= 0; size3--) {
                    ...
                    ViewCompat.setAlpha(viewHolder2.itemView, FullImageView.ASPECT_RATIO_SQUARE);
