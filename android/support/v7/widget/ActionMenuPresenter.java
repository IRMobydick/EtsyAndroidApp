...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(ActionMenuPresenter actionMenuPresenter, Context context, SubMenuBuilder subMenuBuilder) {
            ...
            super(context, subMenuBuilder, null, false, C0234R.attr.actionOverflowMenuStyle);
    ...
    class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        class C02521 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C02521(View view, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0234R.attr.actionOverflowButtonStyle);
            this.mTempPts = new float[2];
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C02521(this, ActionMenuPresenter.this));
        }
    ...
    class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0234R.attr.actionOverflowMenuStyle);
    ...
    class SavedState implements Parcelable {
        ...
        final class C02531 implements Creator<SavedState> {
            C02531() {
            }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0234R.layout.abc_action_menu_layout, C0234R.layout.abc_action_menu_item_layout);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0234R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
