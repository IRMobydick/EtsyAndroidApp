...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    class C02481 extends ViewPropertyAnimatorListenerAdapter {
        C02481() {
        }
    ...
    static {
        ATTRS = new int[]{C0234R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02481();
        this.mRemoveActionBarHideOffset = new C02492();
        this.mAddActionBarHideOffset = new C02503();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0234R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0234R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0234R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float f, float f2) {
        this.mFlingEstimator.fling(0, 0, 0, (int) f2, 0, 0, RtlSpacingHelper.UNDEFINED, MeasureConfiguration.DISABLED);
