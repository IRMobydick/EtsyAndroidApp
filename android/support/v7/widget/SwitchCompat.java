...
public class SwitchCompat extends CompoundButton {
    ...
    class C03181 implements AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            if (SwitchCompat.this.mPositionAnimator == animation) {
                SwitchCompat.this.setThumbPosition(this.val$newCheckedState ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f);
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0234R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0234R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0234R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0234R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0234R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0234R.styleable.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0234R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0234R.styleable.SwitchCompat_splitTrack, false);
        int resourceId = obtainStyledAttributes.getResourceId(C0234R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, C0234R.styleable.TextAppearance);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0234R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0234R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0234R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0234R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public void setSwitchTypeface(Typeface typeface, int i) {
        ...
        if (i > 0) {
            ...
            if ((style & TOUCH_MODE_DRAGGING) != 0) {
                f = -0.25f;
            } else {
                f = 0.0f;
            }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mShowText) {
            max = Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding * TOUCH_MODE_DRAGGING);
        } else {
            max = 0;
        }
        ...
        intrinsicWidth = Math.max(this.mSwitchMinWidth, intrinsicWidth + (max + (this.mThumbWidth * TOUCH_MODE_DRAGGING)));
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        return new StaticLayout(transformation, this.mTextPaint, transformation != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformation, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, FullImageView.ASPECT_RATIO_SQUARE, 0.0f, true);
    }
            ...
            case TOUCH_MODE_DRAGGING /*2*/:
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        x = thumbScrollRange != 0 ? f / ((float) thumbScrollRange) : f > 0.0f ? FullImageView.ASPECT_RATIO_SQUARE : -1.0f;
                        if (ViewUtils.isLayoutRtl(this)) {
                            x = -x;
                        }
                        x = constrain(x + this.mThumbPosition, 0.0f, FullImageView.ASPECT_RATIO_SQUARE);
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        this.mPositionAnimator = new ThumbAnimation(this.mThumbPosition, z ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f, null);
        this.mPositionAnimator.setDuration(250);
        this.mPositionAnimator.setAnimationListener(new C03181(z));
    ...
    public void setChecked(boolean z) {
        ...
        cancelPositionAnimator();
        setThumbPosition(isChecked ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f);
    }
    ...
    private int getThumbOffset() {
        float f;
        if (ViewUtils.isLayoutRtl(this)) {
            f = FullImageView.ASPECT_RATIO_SQUARE - this.mThumbPosition;
        } else {
