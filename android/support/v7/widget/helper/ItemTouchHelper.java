...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C03262 implements OnItemTouchListener {
        C03262() {
        }
    ...
    class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03321 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03321(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C03321(ItemTouchHelper.this));
        ...
        public void onAnimationCancel(ValueAnimatorCompat valueAnimatorCompat) {
            setFraction(FullImageView.ASPECT_RATIO_SQUARE);
        }
    ...
    class C03273 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C03273(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4, int i3, ViewHolder viewHolder2) {
    ...
    class C03284 implements Runnable {
        ...
        C03284(RecoverAnimation recoverAnimation, int i) {
    ...
    class C03295 implements ChildDrawingOrderCallback {
        C03295() {
        }
        ...
        public int onGetChildDrawingOrder(int i, int i2) {
            ...
            return i2 >= access$2300 ? i2 + ItemTouchHelper.UP : i2;
        }
    }
    ...
    public abstract class Callback {
        ...
        final class C03301 implements Interpolator {
            C03301() {
            }
        ...
        final class C03312 implements Interpolator {
            C03312() {
            }
        ...
        static {
            sDragScrollInterpolator = new C03301();
            sDragViewScrollCapInterpolator = new C03312();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0237R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int i, int i2, int i3, long j) {
            ...
            int maxDragScroll = (int) (((float) (getMaxDragScroll(recyclerView) * ((int) Math.signum((float) i2)))) * sDragViewScrollCapInterpolator.getInterpolation(Math.min(FullImageView.ASPECT_RATIO_SQUARE, (((float) Math.abs(i2)) * FullImageView.ASPECT_RATIO_SQUARE) / ((float) i))));
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0237R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0237R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c03273 = new C03273(viewHolder2, i4, i2, f2, f3, f, signum, swipeIfNecessary, viewHolder2);
                    c03273.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c03273);
                    c03273.start();
                    obj = UP;
                } else {
    ...
    private void postDispatchSwipe(RecoverAnimation recoverAnimation, int i) {
        this.mRecyclerView.post(new C03284(recoverAnimation, i));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03295();
            }
