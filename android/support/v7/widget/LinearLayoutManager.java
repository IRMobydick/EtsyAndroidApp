...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    class C02861 extends LinearSmoothScroller {
        C02861(Context context) {
            super(context);
        }
    ...
    public class SavedState implements Parcelable {
        ...
        final class C02871 implements Creator<SavedState> {
            C02871() {
            }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller c02861 = new C02861(recyclerView.getContext());
        c02861.setTargetPosition(i);
        startSmoothScroll(c02861);
    }
