...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03053 implements Runnable {
        C03053() {
        }
    ...
    class C03064 implements OnFocusChangeListener {
        C03064() {
        }
    ...
    class C03075 implements OnLayoutChangeListener {
        C03075() {
        }
    ...
    class C03086 implements OnGlobalLayoutListener {
        C03086() {
        }
    ...
    class C03097 implements OnClickListener {
        C03097() {
        }
    ...
    class C03108 implements OnKeyListener {
        C03108() {
        }
    ...
    class C03119 implements OnEditorActionListener {
        C03119() {
        }
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C03121 implements Creator<SavedState> {
            C03121() {
            }
    ...
    public class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0234R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0234R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mShowImeRunnable = new C03031();
        this.mUpdateDrawableStateRunnable = new C03042();
        this.mReleaseCursorRunnable = new C03053();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03097();
        this.mTextKeyListener = new C03108();
        this.mOnEditorActionListener = new C03119();
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0234R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0234R.styleable.SearchView_layout, C0234R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0234R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0234R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0234R.id.search_plate);
        this.mSubmitArea = findViewById(C0234R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0234R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0234R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0234R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0234R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0234R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0234R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0234R.styleable.SearchView_suggestionRowLayout, C0234R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0234R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03064());
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0234R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0234R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0234R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0234R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0234R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0234R.styleable.SearchView_android_focusable, true));
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03075());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03086());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0234R.dimen.abc_search_view_preferred_width);
    }
    ...
    private boolean hasVoiceSearch() {
        ...
        if (intent == null || getContext().getPackageManager().resolveActivity(intent, AccessibilityNodeInfoCompat.ACTION_CUT) == null) {
            return IS_AT_LEAST_FROYO;
        }
        return true;
    }
    ...
    private void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mSearchSrcTextView.getText())) {
            this.mSearchSrcTextView.setText(StringUtils.EMPTY);
    ...
    public void onActionViewCollapsed() {
        setQuery(StringUtils.EMPTY, IS_AT_LEAST_FROYO);
        clearFocus();
        updateViewsVisibility(true);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0234R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0234R.dimen.abc_dropdownitem_icon_width);
            } else {
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i, String str4) {
        ...
        if (str3 != null) {
            intent.putExtra(ResponseConstants.QUERY, str3);
        }
        if (str2 != null) {
