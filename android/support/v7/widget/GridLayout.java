...
import android.support.v7.gridlayout.C0236R;
...
public class GridLayout extends ViewGroup {
    ...
    final class C02761 implements Printer {
        C02761() {
        }
    ...
    final class C02772 extends Alignment {
        C02772() {
        }
    ...
    final class C02783 extends Alignment {
        C02783() {
        }
    ...
    final class C02794 extends Alignment {
        C02794() {
        }
    ...
    final class C02805 extends Alignment {
        final /* synthetic */ Alignment val$ltr;
        final /* synthetic */ Alignment val$rtl;

        C02805(Alignment alignment, Alignment alignment2) {
    ...
    final class C02816 extends Alignment {
        C02816() {
        }
    ...
    final class C02837 extends Alignment {

        /* renamed from: android.support.v7.widget.GridLayout.7.1 */
        class C02821 extends Bounds {
            private int size;
    ...
    final class C02848 extends Alignment {
        C02848() {
        }
    ...
    final class Axis {
        ...
        private String arcsToString(List<Arc> list) {
            String str = this.horizontal ? EtsyDialogFragment.OPT_X_BUTTON : "y";
        ...
        private boolean solve(Arc[] arcArr, int[] iArr, boolean z) {
            String str = this.horizontal ? ResponseConstants.HORIZONTAL : "vertical";
            int count = getCount() + PENDING;
            boolean[] zArr = null;
            for (int i = NEW; i < arcArr.length; i += PENDING) {
                int i2;
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        static {
            ...
            MARGIN = C0236R.styleable.GridLayout_Layout_android_layout_margin;
            LEFT_MARGIN = C0236R.styleable.GridLayout_Layout_android_layout_marginLeft;
            TOP_MARGIN = C0236R.styleable.GridLayout_Layout_android_layout_marginTop;
            RIGHT_MARGIN = C0236R.styleable.GridLayout_Layout_android_layout_marginRight;
            BOTTOM_MARGIN = C0236R.styleable.GridLayout_Layout_android_layout_marginBottom;
            COLUMN = C0236R.styleable.GridLayout_Layout_layout_column;
            COLUMN_SPAN = C0236R.styleable.GridLayout_Layout_layout_columnSpan;
            COLUMN_WEIGHT = C0236R.styleable.GridLayout_Layout_layout_columnWeight;
            ROW = C0236R.styleable.GridLayout_Layout_layout_row;
            ROW_SPAN = C0236R.styleable.GridLayout_Layout_layout_rowSpan;
            ROW_WEIGHT = C0236R.styleable.GridLayout_Layout_layout_rowWeight;
            GRAVITY = C0236R.styleable.GridLayout_Layout_layout_gravity;
        }
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0236R.styleable.GridLayout_Layout);
            try {
    ...
    static {
        ...
        NO_PRINTER = new C02761();
        ORIENTATION = C0236R.styleable.GridLayout_orientation;
        ROW_COUNT = C0236R.styleable.GridLayout_rowCount;
        COLUMN_COUNT = C0236R.styleable.GridLayout_columnCount;
        USE_DEFAULT_MARGINS = C0236R.styleable.GridLayout_useDefaultMargins;
        ALIGNMENT_MODE = C0236R.styleable.GridLayout_alignmentMode;
        ROW_ORDER_PRESERVED = C0236R.styleable.GridLayout_rowOrderPreserved;
        COLUMN_ORDER_PRESERVED = C0236R.styleable.GridLayout_columnOrderPreserved;
        UNDEFINED_ALIGNMENT = new C02772();
        LEADING = new C02783();
        TRAILING = new C02794();
        TOP = LEADING;
        BOTTOM = TRAILING;
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0236R.dimen.default_gap);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0236R.styleable.GridLayout);
        try {
    ...
    private static Alignment createSwitchingAlignment(Alignment alignment, Alignment alignment2) {
        return new C02805(alignment, alignment2);
    }
