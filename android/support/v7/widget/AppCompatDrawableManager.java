...
public final class AppCompatDrawableManager {
    ...
    static {
        ...
        COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0234R.drawable.abc_textfield_search_default_mtrl_alpha, C0234R.drawable.abc_textfield_default_mtrl_alpha, C0234R.drawable.abc_ab_share_pack_mtrl_alpha};
        TINT_COLOR_CONTROL_NORMAL = new int[]{C0234R.drawable.abc_ic_ab_back_mtrl_am_alpha, C0234R.drawable.abc_ic_go_search_api_mtrl_alpha, C0234R.drawable.abc_ic_search_api_mtrl_alpha, C0234R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0234R.drawable.abc_ic_clear_mtrl_alpha, C0234R.drawable.abc_ic_menu_share_mtrl_alpha, C0234R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0234R.drawable.abc_ic_menu_cut_mtrl_alpha, C0234R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0234R.drawable.abc_ic_menu_paste_mtrl_am_alpha, C0234R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha, C0234R.drawable.abc_ic_voice_search_api_mtrl_alpha};
        COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0234R.drawable.abc_textfield_activated_mtrl_alpha, C0234R.drawable.abc_textfield_search_activated_mtrl_alpha, C0234R.drawable.abc_cab_background_top_mtrl_alpha, C0234R.drawable.abc_text_cursor_material};
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0234R.drawable.abc_popup_background_mtrl_mult, C0234R.drawable.abc_cab_background_internal_bg, C0234R.drawable.abc_menu_hardkey_panel_mtrl_mult};
        TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0234R.drawable.abc_edit_text_material, C0234R.drawable.abc_tab_indicator_material, C0234R.drawable.abc_textfield_search_material, C0234R.drawable.abc_spinner_mtrl_am_alpha, C0234R.drawable.abc_spinner_textfield_background_material, C0234R.drawable.abc_ratingbar_full_material, C0234R.drawable.abc_switch_track_mtrl_alpha, C0234R.drawable.abc_switch_thumb_material, C0234R.drawable.abc_btn_default_mtrl_shape, C0234R.drawable.abc_btn_borderless_material};
        TINT_CHECKABLE_BUTTON_LIST = new int[]{C0234R.drawable.abc_btn_check_material, C0234R.drawable.abc_btn_radio_material};
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (cachedDrawable == null) {
            if (i == C0234R.drawable.abc_cab_background_top_material) {
                cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0234R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0234R.drawable.abc_cab_background_top_mtrl_alpha)});
            }
            if (cachedDrawable != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (i == C0234R.drawable.abc_seekbar_track_material) {
            r0 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (i == C0234R.drawable.abc_ratingbar_indicator_material || i == C0234R.drawable.abc_ratingbar_small_material) {
            r0 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i)) {
            i2 = C0234R.attr.colorControlNormal;
            mode = mode2;
            z = true;
            i3 = -1;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, i)) {
            i2 = C0234R.attr.colorControlActivated;
            mode = mode2;
            z = true;
            i3 = -1;
            ...
            i2 = 16842801;
            i3 = -1;
        } else if (i == C0234R.drawable.abc_list_divider_mtrl_alpha) {
            i2 = 16842800;
            i3 = Math.round(40.8f);
            mode = mode2;
            z = true;
    ...
    final Mode getTintMode(int i) {
        if (i == C0234R.drawable.abc_switch_thumb_material) {
    ...
    public final ColorStateList getTintList(@NonNull Context context, @DrawableRes int i) {
        ...
        if (tintListFromCache == null) {
            if (i == C0234R.drawable.abc_edit_text_material) {
                tintListFromCache = createEditTextColorStateList(context);
            } else if (i == C0234R.drawable.abc_switch_track_mtrl_alpha) {
                tintListFromCache = createSwitchTrackColorStateList(context);
            } else if (i == C0234R.drawable.abc_switch_thumb_material) {
                tintListFromCache = createSwitchThumbColorStateList(context);
            } else if (i == C0234R.drawable.abc_btn_default_mtrl_shape) {
                tintListFromCache = createDefaultButtonColorStateList(context);
            } else if (i == C0234R.drawable.abc_btn_borderless_material) {
                tintListFromCache = createBorderlessButtonColorStateList(context);
            } else if (i == C0234R.drawable.abc_btn_colored_material) {
                tintListFromCache = createColoredButtonColorStateList(context);
            } else if (i == C0234R.drawable.abc_spinner_mtrl_am_alpha || i == C0234R.drawable.abc_spinner_textfield_background_material) {
                tintListFromCache = createSpinnerColorStateList(context);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, i)) {
                tintListFromCache = ThemeUtils.getThemeAttrColorStateList(context, C0234R.attr.colorControlNormal);
            ...
            } else if (i == C0234R.drawable.abc_seekbar_thumb_material) {
    ...
    private ColorStateList createDefaultColorStateList(Context context) {
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlNormal);
        int themeAttrColor2 = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated);
        r2 = new int[7][];
        int[] iArr = new int[]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorControlNormal), ThemeUtils.FOCUSED_STATE_SET, themeAttrColor2, ThemeUtils.ACTIVATED_STATE_SET, themeAttrColor2, ThemeUtils.PRESSED_STATE_SET};
    ...
    private ColorStateList createCheckableButtonColorStateList(Context context) {
        r0 = new int[3][];
        int[] iArr = new int[]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorControlNormal), ThemeUtils.CHECKED_STATE_SET};
        iArr[1] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated);
        r0[2] = ThemeUtils.EMPTY_STATE_SET;
        iArr[2] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlNormal);
    ...
    private ColorStateList createSwitchTrackColorStateList(Context context) {
        ...
        iArr[1] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated, 0.3f);
        r0[2] = ThemeUtils.EMPTY_STATE_SET;
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList themeAttrColorStateList = ThemeUtils.getThemeAttrColorStateList(context, C0234R.attr.colorSwitchThumbNormal);
        if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
            iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorSwitchThumbNormal);
            iArr[1] = ThemeUtils.CHECKED_STATE_SET;
            iArr2[1] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated);
            iArr[2] = ThemeUtils.EMPTY_STATE_SET;
            iArr2[2] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorSwitchThumbNormal);
        } else {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    private ColorStateList createEditTextColorStateList(Context context) {
        r0 = new int[3][];
        int[] iArr = new int[]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorControlNormal), ThemeUtils.NOT_PRESSED_OR_FOCUSED_STATE_SET};
        iArr[1] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlNormal);
        r0[2] = ThemeUtils.EMPTY_STATE_SET;
        iArr[2] = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlActivated);
        return new ColorStateList(r0, iArr);
    }

    private ColorStateList createDefaultButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(Context context, @ColorInt int i) {
        r0 = new int[4][];
        r1 = new int[4];
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0234R.attr.colorControlHighlight);
        r0[0] = ThemeUtils.DISABLED_STATE_SET;
        r1[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorButtonNormal);
    ...
    private ColorStateList createSeekbarThumbColorStateList(Context context) {
        r0 = new int[2][];
        int[] iArr = new int[]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.getDisabledThemeAttrColor(context, C0234R.attr.colorControlActivated)};
