...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02561 extends DataSetObserver {
        C02561() {
        }
    ...
    class C02572 implements OnGlobalLayoutListener {
        C02572() {
        }
    ...
    class C02583 extends ForwardingListener {
        C02583(View view) {
            super(view);
        }
    ...
    class C02594 extends DataSetObserver {
        C02594() {
        }
    ...
    class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (view == null || view.getId() != C0234R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0234R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0234R.id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C0234R.id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    ...
                    ((TextView) view.findViewById(C0234R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0234R.string.abc_activity_chooser_view_see_all));
                    return view;
                default:
                    throw new IllegalArgumentException();
            }
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            switch (((ActivityChooserViewAdapter) adapterView.getAdapter()).getItemViewType(i)) {
                case Task.NETWORK_STATE_CONNECTED /*0*/:
                    ...
                    if (!ActivityChooserView.this.mIsSelectingDefaultActivity) {
                        ...
                        if (chooseActivity != null) {
                            chooseActivity.addFlags(AccessibilityNodeInfoCompat.ACTION_COLLAPSE);
                ...
                case Task.NETWORK_STATE_UNMETERED /*1*/:
                    ActivityChooserView.this.showPopupUnchecked(MeasureConfiguration.DISABLED);
                default:
                    throw new IllegalArgumentException();
            }
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C02561();
        this.mOnGlobalLayoutListener = new C02572();
        this.mInitialActivityCount = 4;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0234R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0234R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0234R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0234R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0234R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0234R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0234R.id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0234R.id.expand_activities_button);
        frameLayout.setOnClickListener(this.mCallbacks);
        frameLayout.setOnTouchListener(new C02583(frameLayout));
        this.mExpandActivityOverflowButton = frameLayout;
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0234R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(drawable);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C02594());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0234R.dimen.abc_config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int i) {
        ...
        if (i == MeasureConfiguration.DISABLED || activityCount <= r3 + i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            listPopupWindow.getListView().setContentDescription(getContext().getString(C0234R.string.abc_activitychooserview_choose_application));
        }
    }
