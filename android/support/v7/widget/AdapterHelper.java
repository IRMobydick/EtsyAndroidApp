...
class AdapterHelper implements Callback {
    ...
    class UpdateOp {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.cmd == MOVE && Math.abs(this.itemCount - this.positionStart) == ADD && this.itemCount == updateOp.positionStart && this.positionStart == updateOp.itemCount) {
                return true;
            }
    ...
    private void applyRemove(UpdateOp updateOp) {
        ...
        while (i3 < i2) {
            ...
            if (obj2 != null) {
                ...
                int i6 = i3;
                i3 = i2;
                i2 = i4 + POSITION_TYPE_NEW_OR_LAID_OUT;
                i5 = i6;
            }
            i4 = i2;
            i2 = i3;
            i3 = i5 + POSITION_TYPE_NEW_OR_LAID_OUT;
        }
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        if (updateOp.cmd == POSITION_TYPE_NEW_OR_LAID_OUT || updateOp.cmd == 8) {
            ...
            if (updateOp.cmd == 8) {
                ...
                if (i4 < i5 || i4 > r2) {
                    if (i4 < updateOp.positionStart) {
                        if (i2 == POSITION_TYPE_NEW_OR_LAID_OUT) {
                ...
                if (updateOp.cmd == POSITION_TYPE_NEW_OR_LAID_OUT) {
    ...
    boolean onItemRangeInserted(int i, int i2) {
        this.mPendingUpdates.add(obtainUpdateOp(POSITION_TYPE_NEW_OR_LAID_OUT, i, i2, null));
