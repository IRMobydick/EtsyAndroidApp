...
class AppCompatTextHelper {
    ...
    static {
        ...
        TEXT_APPEARANCE_ATTRS = new int[]{C0234R.attr.textAllCaps};
    }
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (!(this.mView.getTransformationMethod() instanceof PasswordTransformationMethod)) {
            ...
            boolean z2;
            if (resourceId != -1) {
                TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(resourceId, C0234R.styleable.TextAppearance);
                if (obtainStyledAttributes2.hasValue(C0234R.styleable.TextAppearance_textAllCaps)) {
                    z = obtainStyledAttributes2.getBoolean(C0234R.styleable.TextAppearance_textAllCaps, false);
                    i3 = 1;
                } else {
                    z2 = false;
                    z = false;
