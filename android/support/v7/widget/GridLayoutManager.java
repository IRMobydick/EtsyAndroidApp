...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        while (i6 < i2) {
            ...
            float decoratedMeasurementInOther = (FullImageView.ASPECT_RATIO_SQUARE * ((float) this.mOrientationHelper.getDecoratedMeasurementInOther(view2))) / ((float) layoutParams.mSpanSize);
    ...
    private int updateSpecWithExtra(int i, int i2, int i3) {
        ...
        if (mode == RtlSpacingHelper.UNDEFINED || mode == 1073741824) {
