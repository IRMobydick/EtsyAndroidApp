...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02621 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C02621(View view, DropdownPopup dropdownPopup) {
    ...
    class DropdownPopup extends ListPopupWindow {
        ...
        class C02631 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C02631(AppCompatSpinner appCompatSpinner) {
        ...
        class C02642 implements OnGlobalLayoutListener {
            C02642() {
            }
        ...
        class C02653 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C02653(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i) {
            ...
            setOnItemClickListener(new C02631(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                if (viewTreeObserver != null) {
                    OnGlobalLayoutListener c02642 = new C02642();
                    viewTreeObserver.addOnGlobalLayoutListener(c02642);
                    setOnDismissListener(new C02653(c02642));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0234R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0234R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Theme theme) {
        ...
        TintTypedArray obtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0234R.styleable.Spinner, i, MODE_DIALOG);
        ...
        if (theme != null) {
            ...
            int resourceId = obtainStyledAttributes2.getResourceId(C0234R.styleable.Spinner_popupTheme, MODE_DIALOG);
            if (resourceId != 0) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == MODE_DROPDOWN) {
                                    ...
                                    obtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0234R.styleable.Spinner, i, MODE_DIALOG);
                                    this.mDropDownWidth = obtainStyledAttributes3.getLayoutDimension(C0234R.styleable.Spinner_android_dropDownWidth, -2);
                                    dropdownPopup.setBackgroundDrawable(obtainStyledAttributes3.getDrawable(C0234R.styleable.Spinner_android_popupBackground));
                                    dropdownPopup.setPromptText(obtainStyledAttributes2.getString(C0234R.styleable.Spinner_android_prompt));
                                    obtainStyledAttributes3.recycle();
                                    this.mPopup = dropdownPopup;
                                    this.mForwardingListener = new C02621(this, dropdownPopup);
                                }
                                textArray = obtainStyledAttributes2.getTextArray(C0234R.styleable.Spinner_android_entries);
                                if (textArray != null) {
                                    arrayAdapter = new ArrayAdapter(context, C0234R.layout.support_simple_spinner_dropdown_item, textArray);
                                    arrayAdapter.setDropDownViewResource(C0234R.layout.support_simple_spinner_dropdown_item);
