...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0234R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0234R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    imageView = new AppCompatTextView(getContext(), null, C0234R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0234R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0234R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int i) {
        ...
        if (i == 0) {
            ...
            ViewPropertyAnimatorCompat alpha = ViewCompat.animate(this).alpha(FullImageView.ASPECT_RATIO_SQUARE);
    ...
    public void animateToTab(int i) {
        ...
        this.mTabSelector = new C03021(childAt);
    ...
    public void addTab(Tab tab, boolean z) {
        ...
        this.mTabLayout.addView(createTabView, new LinearLayoutCompat.LayoutParams(0, -1, FullImageView.ASPECT_RATIO_SQUARE));
        if (this.mTabSpinner != null) {
    ...
    public void addTab(Tab tab, int i, boolean z) {
        View createTabView = createTabView(tab, false);
        this.mTabLayout.addView(createTabView, i, new LinearLayoutCompat.LayoutParams(0, -1, FullImageView.ASPECT_RATIO_SQUARE));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (z) {
