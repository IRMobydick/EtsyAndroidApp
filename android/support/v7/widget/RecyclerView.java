...
import android.support.v7.recyclerview.C0237R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public abstract class LayoutManager {
        ...
        void setMeasuredDimensionFromChildren(int i, int i2) {
            ...
            int i7 = MeasureConfiguration.DISABLED;
            while (i5 < childCount) {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0237R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0237R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = obtainStyledAttributes.getInt(C0237R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0237R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0237R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
    ...
    final class C02963 implements Interpolator {
        C02963() {
        }

        public float getInterpolation(float f) {
            float f2 = f - FullImageView.ASPECT_RATIO_SQUARE;
            return (f2 * (((f2 * f2) * f2) * f2)) + FullImageView.ASPECT_RATIO_SQUARE;
        }
    }

    /* renamed from: android.support.v7.widget.RecyclerView.4 */
    class C02974 implements ProcessCallback {
        C02974() {
        }
    ...
    class C02985 implements Callback {
        C02985() {
        }
    ...
    class C02996 implements Callback {
        C02996() {
        }
    ...
    public final class Recycler {
                ...
                if (viewHolder != null) {
                    ...
                    if (viewHolder == null) {
                        ...
                        if (viewHolder == null) {
                            ...
                            z5 = z4;
                            if (z5 && !RecyclerView.this.mState.isPreLayout() && changedScrapViewForPosition.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD)) {
        ...
        void setAdapterPositionsAsUnknown() {
            ...
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < size; i += RecyclerView.VERTICAL) {
                ...
                if (viewHolder != null) {
                    viewHolder.addFlags(AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY);
                }
            }
        }
    ...
    public class SavedState extends BaseSavedState {
        ...
        final class C03001 implements Creator<SavedState> {
            C03001() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int i, int i2) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, i, i2, RtlSpacingHelper.UNDEFINED, MeasureConfiguration.DISABLED, RtlSpacingHelper.UNDEFINED, MeasureConfiguration.DISABLED);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            float distanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(FullImageView.ASPECT_RATIO_SQUARE, (((float) sqrt2) * FullImageView.ASPECT_RATIO_SQUARE) / ((float) width))) * ((float) i5)) + ((float) i5);
            if (sqrt > 0) {
                ...
                round = (int) (((((float) round) / ((float) width)) + FullImageView.ASPECT_RATIO_SQUARE) * 300.0f);
            }
    ...
    static {
        ...
        sQuinticInterpolator = new C02963();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02941();
        ...
        this.mItemAnimatorRunner = new C02952();
        this.mViewInfoProcessCallback = new C02974();
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0237R.styleable.RecyclerView, i, TOUCH_SLOP_DEFAULT);
            String string = obtainStyledAttributes.getString(C0237R.styleable.RecyclerView_layoutManager);
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02985());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02996());
    }
        ...
        if (dispatchOnItemTouch(motionEvent)) {
            ...
            switch (actionMasked) {
                ...
                case VERTICAL /*1*/:
                    ...
                    this.mVelocityTracker.computeCurrentVelocity(Constants.APPBOY_MINIMUM_NOTIFICATION_DURATION_MILLIS, (float) this.mMaxFlingVelocity);
