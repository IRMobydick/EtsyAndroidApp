...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0234R.styleable.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0234R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0234R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0234R.styleable.LinearLayoutCompat, i, SHOW_DIVIDER_NONE);
        int i2 = obtainStyledAttributes.getInt(C0234R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        i2 = obtainStyledAttributes.getInt(C0234R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i2 >= 0) {
            setGravity(i2);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0234R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0234R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0234R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0234R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0234R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0234R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0234R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        obtainStyledAttributes.recycle();
    }
        ...
        while (i11 < virtualChildCount) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (i11 >= i9 || layoutParams.weight <= 0.0f) {
                    ...
                    obj5 = (obj == null || layoutParams.width != -1) ? null : VERTICAL;
        ...
        if (obj3 != null || (i4 != 0 && f > 0.0f)) {
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    obj5 = (obj8 == null || layoutParams2.width != -1) ? null : VERTICAL;
    ...
    void measureHorizontal(int i, int i2) {
        ...
        while (i11 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                i12 = virtualChildAt.getMeasuredHeight() + i4;
            ...
            while (i5 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    if (obj != null) {
                        ...
                        this.mTotalLength = Math.max(i4, (layoutParams.rightMargin + ((i4 + i10) + layoutParams.leftMargin)) + getNextLocationOffset(virtualChildAt2));
                        i3 = i5;
                    }
                }
                i5 = i3 + VERTICAL;
        ...
        if (obj4 != null || (i5 != 0 && f > 0.0f)) {
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    obj5 = (mode2 == 1073741824 || layoutParams.height != -1) ? null : VERTICAL;
                    ...
                    i11 = Math.max(i16, i5);
                    obj5 = (obj9 == null || layoutParams.height != -1) ? null : VERTICAL;
                    if (z) {
