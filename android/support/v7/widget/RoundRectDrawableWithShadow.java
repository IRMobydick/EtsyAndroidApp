...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, int i, float f, float f2, float f3) {
        ...
        this.mShadowStartColor = resources.getColor(C0235R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0235R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0235R.dimen.cardview_compat_inset_shadow);
    ...
    private void buildShadowCorners() {
        ...
        float[] fArr = new float[]{0.0f, f, FullImageView.ASPECT_RATIO_SQUARE};
        f = 0.0f;
        ...
        float f2 = 0.0f;
        this.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, (-this.mCornerRadius) + this.mShadowSize, f2, (-this.mCornerRadius) - this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, 0.5f, FullImageView.ASPECT_RATIO_SQUARE}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
