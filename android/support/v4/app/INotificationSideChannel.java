        ...
        class Proxy implements INotificationSideChannel {
            ...
            public void notify(String str, int i, String str2, Notification notification) {
                ...
                try {
                    ...
                    if (notification != null) {
                        obtain.writeInt(Stub.TRANSACTION_notify);
                        notification.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_notify, obtain, null, Stub.TRANSACTION_notify);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void cancel(String str, int i, String str2) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeString(str2);
                    this.mRemote.transact(Stub.TRANSACTION_cancel, obtain, null, Stub.TRANSACTION_notify);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void cancelAll(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    this.mRemote.transact(Stub.TRANSACTION_cancelAll, obtain, null, Stub.TRANSACTION_notify);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case TRANSACTION_notify /*1*/:
                    ...
                    return true;
                case TRANSACTION_cancel /*2*/:
                    parcel.enforceInterface(DESCRIPTOR);
                    cancel(parcel.readString(), parcel.readInt(), parcel.readString());
                    return true;
                case TRANSACTION_cancelAll /*3*/:
                    parcel.enforceInterface(DESCRIPTOR);
