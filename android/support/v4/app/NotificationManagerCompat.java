...
public final class NotificationManagerCompat {
    ...
    private NotificationManagerCompat(Context context) {
        this.mContext = context;
        this.mNotificationManager = (NotificationManager) this.mContext.getSystemService(Configuration.NOTIFICATION_LAYOUT_NAME);
    }
    ...
    public static Set<String> getEnabledListenerPackages(Context context) {
        ...
        if (!(string == null || string.equals(sEnabledNotificationListeners))) {
            String[] split = string.split(Draft.IMAGE_DELIMITER);
