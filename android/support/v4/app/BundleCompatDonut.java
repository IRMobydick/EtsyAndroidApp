...
class BundleCompatDonut {
    ...
    L_0x0024:
        r0 = sGetIBinderMethod;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r2 = 1;
        r2 = new java.lang.Object[r2];	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r3 = 0;
        r2[r3] = r8;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r0 = r0.invoke(r7, r2);	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r0 = (android.os.IBinder) r0;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
    L_0x0032:
        return r0;
    L_0x0033:
        r0 = move-exception;
    ...
    L_0x0028:
        r0 = sPutIBinderMethod;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r1 = 2;
        r1 = new java.lang.Object[r1];	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r2 = 0;
        r1[r2] = r7;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r2 = 1;
        r1[r2] = r8;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r0.invoke(r6, r1);	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
    L_0x0036:
        return;
    L_0x0037:
        r0 = move-exception;
