...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.mActive != null) {
            ...
            if (size > 0) {
                ...
                printWriter.println(Draft.IMAGE_DELIMITER);
    ...
    Animation loadAnimation(Fragment fragment, int i, boolean z, int i2) {
        ...
        switch (transitToStyleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, FullImageView.ASPECT_RATIO_SQUARE, 0.0f, FullImageView.ASPECT_RATIO_SQUARE);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), FullImageView.ASPECT_RATIO_SQUARE, 0.975f, FullImageView.ASPECT_RATIO_SQUARE, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, FullImageView.ASPECT_RATIO_SQUARE, 0.0f, FullImageView.ASPECT_RATIO_SQUARE);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), FullImageView.ASPECT_RATIO_SQUARE, 1.075f, FullImageView.ASPECT_RATIO_SQUARE, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, FullImageView.ASPECT_RATIO_SQUARE);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mHost.getContext(), FullImageView.ASPECT_RATIO_SQUARE, 0.0f);
            default:
    ...
    L_0x00fc:
        r1 = r2;
    L_0x00fd:
        r1 = r0.popFromBackStack(r1, r5, r8, r9);
        r0 = r4 + 1;
        r4 = r0;
        r5 = r1;
        goto L_0x00d2;
