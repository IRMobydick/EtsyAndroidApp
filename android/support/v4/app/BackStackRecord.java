...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00641 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C00641(Fragment fragment) {
    ...
    class C00652 implements OnPreDrawListener {
        final /* synthetic */ Fragment val$inFragment;
        ...
        C00652(View view, Object obj, ArrayList arrayList, TransitionState transitionState, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C00663 implements OnPreDrawListener {
        final /* synthetic */ int val$containerId;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ TransitionState val$state;
        final /* synthetic */ Object val$transition;

        C00663(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
        ...
        if (sharedElementTransition != null) {
            ...
            if (map.isEmpty()) {
                ...
                if (mergeTransitions != null) {
                    FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, view, c00641, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList2, map, arrayMap, arrayList3);
    ...
    private void prepareSharedElementTransition(TransitionState transitionState, View view, Object obj, Fragment fragment, Fragment fragment2, boolean z, ArrayList<View> arrayList) {
        view.getViewTreeObserver().addOnPreDrawListener(new C00652(view, obj, arrayList, transitionState, z, fragment, fragment2));
    }
    ...
    private void excludeHiddenFragmentsAfterEnter(View view, TransitionState transitionState, int i, Object obj) {
        view.getViewTreeObserver().addOnPreDrawListener(new C00663(view, transitionState, i, obj));
    }
