...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private static String viewToString(View view) {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || resources == null)) {
                ...
                stringBuilder.append(Draft.IMAGE_DELIMITER);
    ...
    public final void validateRequestPermissionsRequestCode(int i) {
        if (!this.mRequestedPermissionsFromFragment && i != -1 && (SupportMenu.CATEGORY_MASK & i) != 0) {
            throw new IllegalArgumentException("Can only use lower 16 bits for requestCode");
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, @Nullable Bundle bundle) {
        ...
        if (i == -1) {
            ...
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + MSG_REALLY_STOPPED) << 16) + (SupportMenu.USER_MASK & i), bundle);
            this.mStartedActivityFromFragment = false;
        }
    }
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        if (i == -1) {
            ...
            try {
                ...
                ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + MSG_REALLY_STOPPED) << 16) + (SupportMenu.USER_MASK & i));
            } finally {
