...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    public int getOpacity() {
        ...
        Bitmap bitmap = this.mBitmap;
        if (bitmap == null || bitmap.hasAlpha() || this.mPaint.getAlpha() < ValidationUtils.APPBOY_STRING_MAX_LENGTH || isGreaterThanZero(this.mCornerRadius)) {
            return -3;
        }
        return -1;
    }
    ...
    RoundedBitmapDrawable(Resources resources, Bitmap bitmap) {
        this.mTargetDensity = AppboyImageUtils.BASELINE_SCREEN_DPI;
        this.mGravity = 119;
