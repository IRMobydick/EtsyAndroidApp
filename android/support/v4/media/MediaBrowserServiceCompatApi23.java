...
class MediaBrowserServiceCompatApi23 extends MediaBrowserServiceCompatApi21 {
    ...
    class MediaBrowserServiceAdaptorApi23 extends MediaBrowserServiceAdaptorApi21 {

        class ServiceBinderProxyApi23 extends ServiceBinderProxyApi21 {
            ...
            class C01131 implements ItemCallback {
                final /* synthetic */ String val$KEY_MEDIA_ITEM;
                final /* synthetic */ ResultReceiver val$receiver;

                C01131(String str, ResultReceiver resultReceiver) {
            ...
            public void getMediaItem(String str, ResultReceiver resultReceiver) {
                Throwable e;
                try {
                    this.mServiceImpl.getMediaItem(str, new C01131((String) MediaBrowserService.class.getDeclaredField("KEY_MEDIA_ITEM").get(null), resultReceiver));
