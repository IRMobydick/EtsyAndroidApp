...
class TransportMediatorJellybeanMR2 {
    ...
    class C01191 implements OnWindowAttachListener {
        C01191() {
        }
    ...
    class C01202 implements OnWindowFocusChangeListener {
        C01202() {
        }
    ...
    class C01213 extends BroadcastReceiver {
        C01213() {
        }
    ...
    class C01224 implements OnAudioFocusChangeListener {
        C01224() {
        }
    ...
    class C01235 implements OnGetPlaybackPositionListener {
        C01235() {
        }
    ...
    class C01246 implements OnPlaybackPositionUpdateListener {
        C01246() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new C01191();
        this.mWindowFocusListener = new C01202();
        this.mMediaButtonReceiver = new C01213();
        this.mAudioFocusChangeListener = new C01224();
        this.mGetPlaybackPositionListener = new C01235();
        this.mPlaybackPositionUpdateListener = new C01246();
        this.mPlayState = 0;
    ...
    public void refreshState(boolean z, long j, int i) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(z ? 3 : 1, j, z ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f);
