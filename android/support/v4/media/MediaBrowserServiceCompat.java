...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C01022 implements Runnable {
        ...
        C01022(String str, Bundle bundle) {
    ...
    class C01033 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C01033(Object obj, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C01044 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C01044(Object obj, ResultReceiver resultReceiver) {
    ...
    class ServiceImpl {
        ...
        class C01051 implements Runnable {
            ...
            C01051(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C01062 implements Runnable {
            ...
            C01062(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C01073 implements Runnable {
            ...
            C01073(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C01084 implements Runnable {
            ...
            C01084(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C01095 implements Runnable {
            final /* synthetic */ String val$mediaId;
            final /* synthetic */ ResultReceiver val$receiver;

            C01095(String str, ResultReceiver resultReceiver) {
        ...
        class C01106 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C01106(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C01117 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C01117(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String str, int i, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01051(serviceCallbacks, str, bundle, i));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01062(serviceCallbacks));
        }

        public void addSubscription(String str, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01073(serviceCallbacks, str, bundle));
        }

        public void removeSubscription(String str, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01084(serviceCallbacks, str, bundle));
        }

        public void getMediaItem(String str, ResultReceiver resultReceiver) {
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01095(str, resultReceiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01106(serviceCallbacks));
        }

        public void unregisterCallbacks(ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01117(serviceCallbacks));
        }
    }
    ...
    class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C01121 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C01121(Handler handler, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String str, ItemCallback itemCallback) {
            this.mServiceImpl.getMediaItem(str, new C01121(MediaBrowserServiceCompat.this.mHandler, itemCallback));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C01011(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String str, Bundle bundle) {
        ...
        this.mHandler.post(new C01022(str, bundle));
    }
    ...
    private void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        Result c01033 = new C01033(str, connectionRecord, str, bundle);
        if (bundle == null) {
            onLoadChildren(str, c01033);
        } else {
            onLoadChildren(str, c01033, bundle);
        }
        if (!c01033.isDone()) {
    ...
    private void performLoadItem(String str, ResultReceiver resultReceiver) {
        Result c01044 = new C01044(str, resultReceiver);
        onLoadItem(str, c01044);
        if (!c01044.isDone()) {
