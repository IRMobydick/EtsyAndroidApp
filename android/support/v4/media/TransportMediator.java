...
public class TransportMediator extends TransportController {
    ...
    class C01171 implements TransportMediatorCallback {
        C01171() {
        }
    ...
    class C01182 implements Callback {
        C01182() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C01171();
        this.mKeyEventCallback = new C01182();
