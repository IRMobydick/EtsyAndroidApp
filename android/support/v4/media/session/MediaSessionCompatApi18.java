...
class MediaSessionCompatApi18 {
    ...
    public static void setState(Object obj, int i, long j, float f, long j2) {
        ...
        if (i == 3 && j > 0) {
            if (j2 > 0) {
                ...
                if (f > 0.0f && f != FullImageView.ASPECT_RATIO_SQUARE) {
                    j3 = (long) (((float) j3) * f);
                }
            }
            j += j3;
    ...
    static int getRccTransportControlFlagsFromActions(long j) {
        ...
        if ((ACTION_SEEK_TO & j) != 0) {
            return rccTransportControlFlagsFromActions | AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY;
        }
