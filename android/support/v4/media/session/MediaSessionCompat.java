...
public class MediaSessionCompat {
    ...
    class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C01291 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01291() {
            }
        ...
        class MediaSessionStub extends Stub {
            ...
            public void playFromMediaId(String str, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS, str, bundle);
            }
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
            ...
            this.mVolumeCallback = new C01291();
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object c01302 = new C01302();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c01302));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c01302));
            }
        }
    ...
    public final class QueueItem implements Parcelable {
        ...
        final class C01311 implements Creator<QueueItem> {
            C01311() {
            }
    ...
    final class ResultReceiverWrapper implements Parcelable {
        ...
        final class C01321 implements Creator<ResultReceiverWrapper> {
            C01321() {
            }
    ...
    public final class Token implements Parcelable {
        ...
        final class C01331 implements Creator<Token> {
            C01331() {
            }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
        ...
        if (context == null) {
            ...
            if (componentName == null) {
                ...
                if (queryBroadcastReceivers.size() == FLAG_HANDLES_MEDIA_BUTTONS) {
                    ResolveInfo resolveInfo = (ResolveInfo) queryBroadcastReceivers.get(0);
                    componentName = new ComponentName(resolveInfo.activityInfo.packageName, resolveInfo.activityInfo.name);
                } else if (queryBroadcastReceivers.size() > FLAG_HANDLES_MEDIA_BUTTONS) {
