...
public final class RatingCompat implements Parcelable {
    ...
    final class C01161 implements Creator<RatingCompat> {
        C01161() {
        }
    ...
    public static RatingCompat newHeartRating(boolean z) {
        return new RatingCompat(RATING_HEART, z ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean z) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, z ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != FullImageView.ASPECT_RATIO_SQUARE) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == FullImageView.ASPECT_RATIO_SQUARE) {
            return true;
        }
        return false;
    }
