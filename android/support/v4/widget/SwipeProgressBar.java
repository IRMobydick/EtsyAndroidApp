...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            } else if (f >= 25.0f && f < Constants.LOCATION_UPDATE_DISTANCE_LOCAL_CONFIG_MINIMUM) {
                canvas.drawColor(this.mColor1);
            } else if (f < Constants.LOCATION_UPDATE_DISTANCE_LOCAL_CONFIG_MINIMUM || f >= 75.0f) {
            ...
            if (f >= 0.0f && f <= Constants.LOCATION_UPDATE_DISTANCE_LOCAL_CONFIG_MINIMUM) {
                canvas2 = canvas;
            ...
            if (f >= Constants.LOCATION_UPDATE_DISTANCE_LOCAL_CONFIG_MINIMUM && f <= 100.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor4, ((f - Constants.LOCATION_UPDATE_DISTANCE_LOCAL_CONFIG_MINIMUM) * 2.0f) / 100.0f);
            }
            if (f >= 75.0f && f <= 100.0f) {
                canvas2 = canvas;
