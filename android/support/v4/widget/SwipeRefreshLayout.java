...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    class C01971 implements AnimationListener {
        C01971() {
        }
    ...
    class C01982 extends Animation {
        C01982() {
        }
    ...
    class C01993 extends Animation {
        C01993() {
        }

        public void applyTransformation(float f, Transformation transformation) {
            SwipeRefreshLayout.this.setAnimationProgress(FullImageView.ASPECT_RATIO_SQUARE - f);
        }
    }

    /* renamed from: android.support.v4.widget.SwipeRefreshLayout.4 */
    class C02004 extends Animation {
    ...
    class C02015 implements AnimationListener {
        C02015() {
        }
    ...
    class C02026 extends Animation {
        C02026() {
        }
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            if (SwipeRefreshLayout.this.mUsingCustomStart) {
                access$1100 = (int) SwipeRefreshLayout.this.mSpinnerFinalOffset;
            } else {
                access$1100 = (int) (SwipeRefreshLayout.this.mSpinnerFinalOffset - ((float) Math.abs(SwipeRefreshLayout.this.mOriginalOffsetTop)));
            }
            SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((((int) (((float) (access$1100 - SwipeRefreshLayout.this.mFrom)) * f)) + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop(), false);
            SwipeRefreshLayout.this.mProgress.setArrowScale(FullImageView.ASPECT_RATIO_SQUARE - f);
        }
    }

    /* renamed from: android.support.v4.widget.SwipeRefreshLayout.7 */
    class C02037 extends Animation {
        C02037() {
        }
    ...
    class C02048 extends Animation {
        C02048() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C01971();
        this.mAnimateToCorrectPosition = new C02026();
        this.mAnimateToStartPosition = new C02037();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C01982();
    ...
    private void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C01993();
    ...
    private Animation startAlphaAnimation(int i, int i2) {
        ...
        Animation c02004 = new C02004(i, i2);
        c02004.setDuration(300);
        this.mCircleView.setAnimationListener(null);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02004);
        return c02004;
    }
    ...
    private void moveSpinner(float f) {
        ...
        float min = Math.min(FullImageView.ASPECT_RATIO_SQUARE, Math.abs(f / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, FullImageView.ASPECT_RATIO_SQUARE);
            ViewCompat.setScaleY(this.mCircleView, FullImageView.ASPECT_RATIO_SQUARE);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(FullImageView.ASPECT_RATIO_SQUARE, f / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(FullImageView.ASPECT_RATIO_SQUARE, max));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case DEFAULT /*1*/:
                ...
                y = (MotionEventCompat.getY(motionEvent, actionMasked) - this.mInitialMotionY) * DRAG_RATE;
                this.mIsBeingDragged = false;
                finishSpinner(y);
                this.mActivePointerId = INVALID_POINTER;
                return false;
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02048();
