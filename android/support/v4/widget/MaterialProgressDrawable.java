...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01871 extends Animation {
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            if (f <= MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) {
                ...
                this.val$ring.setStartTrim(startingStartTrim + (MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f / MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) * f2));
            }
            if (f > MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) {
            ...
            MaterialProgressDrawable.this.setRotation((216.0f * f) + (MaterialProgressDrawable.FULL_ROTATION * (MaterialProgressDrawable.this.mRotationCount / MaterialProgressDrawable.NUM_POINTS)));
        }
    }

    /* renamed from: android.support.v4.widget.MaterialProgressDrawable.2 */
    class C01882 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
        ...
        public void onAnimationRepeat(Animation animation) {
            ...
            MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + FullImageView.ASPECT_RATIO_SQUARE) % MaterialProgressDrawable.NUM_POINTS;
        }
    }

    /* renamed from: android.support.v4.widget.MaterialProgressDrawable.3 */
    class C01893 implements Callback {
        C01893() {
        }
    ...
    class Ring {
        ...
        public void draw(Canvas canvas, Rect rect) {
            ...
            if (this.mAlpha < ValidationUtils.APPBOY_STRING_MAX_LENGTH) {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        int i3 = (intValue >> 24) & ValidationUtils.APPBOY_STRING_MAX_LENGTH;
        int i4 = (intValue >> 16) & ValidationUtils.APPBOY_STRING_MAX_LENGTH;
        int i5 = (intValue >> 8) & ValidationUtils.APPBOY_STRING_MAX_LENGTH;
        intValue &= ValidationUtils.APPBOY_STRING_MAX_LENGTH;
        int intValue2 = Integer.valueOf(i2).intValue();
        return (intValue + ((int) (((float) ((intValue2 & ValidationUtils.APPBOY_STRING_MAX_LENGTH) - intValue)) * f))) | ((((i3 + ((int) (((float) (((intValue2 >> 24) & ValidationUtils.APPBOY_STRING_MAX_LENGTH) - i3)) * f))) << 24) | ((i4 + ((int) (((float) (((intValue2 >> 16) & ValidationUtils.APPBOY_STRING_MAX_LENGTH) - i4)) * f))) << 16)) | ((((int) (((float) (((intValue2 >> 8) & ValidationUtils.APPBOY_STRING_MAX_LENGTH) - i5)) * f)) + i5) << 8));
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c01871 = new C01871(ring);
        c01871.setRepeatCount(-1);
        c01871.setRepeatMode(DEFAULT);
        c01871.setInterpolator(LINEAR_INTERPOLATOR);
        c01871.setAnimationListener(new C01882(ring));
        this.mAnimation = c01871;
    }
}
