...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    static {
        ...
        INVALID_PARENT_BOUNDS = new Rect(MeasureConfiguration.DISABLED, MeasureConfiguration.DISABLED, INVALID_ID, INVALID_ID);
    }
    ...
    public void invalidateVirtualView(int i) {
        sendEventForVirtualView(i, ItemAnimator.FLAG_MOVED);
    }
