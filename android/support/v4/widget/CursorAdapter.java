...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilterClient, Filterable {
    ...
    void init(Context context, Cursor cursor, int i) {
        boolean z = true;
        if ((i & FLAG_AUTO_REQUERY) == FLAG_AUTO_REQUERY) {
            i |= FLAG_REGISTER_CONTENT_OBSERVER;
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(PerfDb.COL_ID) : -1;
        if ((i & FLAG_REGISTER_CONTENT_OBSERVER) == FLAG_REGISTER_CONTENT_OBSERVER) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(PerfDb.COL_ID);
    ...
    public CharSequence convertToString(Cursor cursor) {
        return cursor == null ? StringUtils.EMPTY : cursor.toString();
    }
