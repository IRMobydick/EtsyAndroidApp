...
public class SlidingPaneLayout extends ViewGroup {
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C01961 implements Creator<SavedState> {
            C01961() {
            }
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    mode = MeasureSpec.makeMeasureSpec(paddingLeft - mode, RtlSpacingHelper.UNDEFINED);
                ...
                if (layoutParams.height == -2) {
                    i8 = MeasureSpec.makeMeasureSpec(mode2, RtlSpacingHelper.UNDEFINED);
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            ...
                            if (obj == null) {
                                ...
                                size2 = MeasureSpec.makeMeasureSpec(mode2, RtlSpacingHelper.UNDEFINED);
                            } else if (layoutParams.height == -1) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mFirstLayout) {
            float f = (this.mCanSlide && this.mPreservedOpenState) ? FullImageView.ASPECT_RATIO_SQUARE : 0.0f;
            this.mSlideOffset = f;
        }
        int i7 = 0;
        int i8 = paddingRight;
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i5 = (int) ((FullImageView.ASPECT_RATIO_SQUARE - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i10 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i9 = (i6 - i10) + i5;
    ...
    private boolean openPane(View view, int i) {
        if (!this.mFirstLayout && !smoothSlideTo(FullImageView.ASPECT_RATIO_SQUARE, i)) {
            return false;
        }
    ...
    public boolean isOpen() {
        return !this.mCanSlide || this.mSlideOffset == FullImageView.ASPECT_RATIO_SQUARE;
    }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt == this.mSlideableView) {
                        i2 = (int) ((FullImageView.ASPECT_RATIO_SQUARE - this.mParallaxOffset) * ((float) this.mParallaxBy));
                        this.mParallaxOffset = f;
                        i2 -= (int) ((FullImageView.ASPECT_RATIO_SQUARE - f) * ((float) this.mParallaxBy));
                        if (isLayoutRtlSupport) {
                            i2 = -i2;
                        }
                        childAt.offsetLeftAndRight(i2);
                        if (obj == null) {
                            dimChildView(childAt, isLayoutRtlSupport ? this.mParallaxOffset - FullImageView.ASPECT_RATIO_SQUARE : FullImageView.ASPECT_RATIO_SQUARE - this.mParallaxOffset, this.mCoveredFadeColor);
                        }
                    }
                }
            }
