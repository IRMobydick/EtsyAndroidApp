...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild, NestedScrollingParent, ScrollingView {
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C01901 implements Creator<SavedState> {
            C01901() {
            }
                        ...
                        if (!dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.mScrollOffset)) {
                            if (obj != null) {
                                ...
                                if (actionMasked < 0) {
                                    ...
                                    this.mEdgeGlowBottom.onPull(((float) i) / ((float) getHeight()), FullImageView.ASPECT_RATIO_SQUARE - (MotionEventCompat.getX(motionEvent, findPointerIndex) / ((float) getWidth())));
