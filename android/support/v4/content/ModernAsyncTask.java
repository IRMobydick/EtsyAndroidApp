...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    final class C00841 implements ThreadFactory {
    ...
    class C00852 extends WorkerRunnable<Params, Result> {
        C00852() {
            super();
        }
    ...
    class C00863 extends FutureTask<Result> {
        C00863(Callable callable) {
            super(callable);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00852();
        this.mFuture = new C00863(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            switch (C00874.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
