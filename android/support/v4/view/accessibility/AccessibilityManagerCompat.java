...
public final class AccessibilityManagerCompat {
    ...
    class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class C01721 implements AccessibilityStateChangeListenerBridge {
            final /* synthetic */ AccessibilityStateChangeListenerCompat val$listener;

            C01721(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
        ...
        public Object newAccessiblityStateChangeListener(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new C01721(accessibilityStateChangeListenerCompat));
        }
