...
public final class GestureDetectorCompat {
    ...
    class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            boolean z = (action & ValidationUtils.APPBOY_STRING_MAX_LENGTH) == 6;
            ...
            switch (action & ValidationUtils.APPBOY_STRING_MAX_LENGTH) {
                ...
                case SHOW_PRESS /*1*/:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(Constants.APPBOY_MINIMUM_NOTIFICATION_DURATION_MILLIS, (float) this.mMaximumFlingVelocity);
                        ...
                        hasMessages = (Math.abs(yVelocity) > ((float) this.mMinimumFlingVelocity) || Math.abs(xVelocity) > ((float) this.mMinimumFlingVelocity)) ? this.mListener.onFling(this.mCurrentDownEvent, motionEvent, xVelocity, yVelocity) : LONGPRESS_TIMEOUT;
                    }
                ...
                case LONG_PRESS /*2*/:
                    ...
                    if (this.mAlwaysInTapRegion) {
                        ...
                        return hasMessages;
                    } else if (Math.abs(xVelocity) < FullImageView.ASPECT_RATIO_SQUARE && Math.abs(yVelocity) < FullImageView.ASPECT_RATIO_SQUARE) {
                        return false;
                    } else {
                ...
                case CommonStatusCodes.RESOLUTION_REQUIRED /*6*/:
                    ...
                    this.mLastFocusY = f;
                    this.mDownFocusY = f;
                    this.mVelocityTracker.computeCurrentVelocity(Constants.APPBOY_MINIMUM_NOTIFICATION_DURATION_MILLIS, (float) this.mMaximumFlingVelocity);
