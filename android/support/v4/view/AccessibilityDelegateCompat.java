...
public class AccessibilityDelegateCompat {
    ...
    class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        class C01531 implements AccessibilityDelegateBridge {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C01531(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new C01531(accessibilityDelegateCompat));
        }
    ...
    class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        class C01541 implements AccessibilityDelegateBridgeJellyBean {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C01541(AccessibilityDelegateCompat accessibilityDelegateCompat) {
                this.val$compat = accessibilityDelegateCompat;
            }
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new C01541(accessibilityDelegateCompat));
        }
