...
class ViewPropertyAnimatorCompatICS {
    ...
    final class C01691 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C01691(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void m13x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m14y(View view, float f) {
        view.animate().y(f);
    }
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C01691(viewPropertyAnimatorListener, view));
        } else {
