...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mTabAlpha = ValidationUtils.APPBOY_STRING_MAX_LENGTH;
        ...
        this.mFullUnderlineHeight = (int) ((FullImageView.ASPECT_RATIO_SQUARE * f) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C01581());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C01592());
