...
public final class MenuItemCompat {
    ...
    class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        class C01571 implements SupportActionExpandProxy {
            final /* synthetic */ OnActionExpandListener val$listener;

            C01571(OnActionExpandListener onActionExpandListener) {
        ...
        public MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
            ...
            return MenuItemCompatIcs.setOnActionExpandListener(menuItem, new C01571(onActionExpandListener));
        }
    }
