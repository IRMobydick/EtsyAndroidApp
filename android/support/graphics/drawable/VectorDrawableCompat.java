...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    class VPath {
        ...
        public String NodesToString(PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = VectorDrawableCompat.LINEJOIN_MITER; i < pathDataNodeArr.length; i += VectorDrawableCompat.LINEJOIN_ROUND) {
                String str2 = str + pathDataNodeArr[i].type + Draft.IMAGE_DELIMITER;
    ...
    class VFullPath extends VPath {
        ...
        public VFullPath() {
            ...
            this.mStrokeAlpha = FullImageView.ASPECT_RATIO_SQUARE;
            this.mFillAlpha = FullImageView.ASPECT_RATIO_SQUARE;
            this.mTrimPathStart = 0.0f;
            this.mTrimPathEnd = FullImageView.ASPECT_RATIO_SQUARE;
    ...
    class VGroup {
        ...
        public VGroup(VGroup vGroup, ArrayMap<String, Object> arrayMap) {
            ...
            this.mPivotX = 0.0f;
            this.mPivotY = 0.0f;
            this.mScaleX = FullImageView.ASPECT_RATIO_SQUARE;
            this.mScaleY = FullImageView.ASPECT_RATIO_SQUARE;
    ...
    class VPathRenderer {
        ...
        public VPathRenderer() {
            ...
            this.mRootAlpha = ValidationUtils.APPBOY_STRING_MAX_LENGTH;
            this.mRootName = null;
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            Matrix access$700 = vGroup.mStackedMatrix;
            this.mFinalPathMatrix.set(access$700);
            this.mFinalPathMatrix.postScale(f, f2);
            f = getMatrixScale(access$700);
            if (f != 0.0f) {
                ...
                if (!(vFullPath.mTrimPathStart == 0.0f && vFullPath.mTrimPathEnd == FullImageView.ASPECT_RATIO_SQUARE)) {
                    float f3 = (vFullPath.mTrimPathStart + vFullPath.mTrimPathOffset) % FullImageView.ASPECT_RATIO_SQUARE;
                    float f4 = (vFullPath.mTrimPathEnd + vFullPath.mTrimPathOffset) % FullImageView.ASPECT_RATIO_SQUARE;
        ...
        private float getMatrixScale(Matrix matrix) {
            float[] fArr = new float[]{0.0f, FullImageView.ASPECT_RATIO_SQUARE, FullImageView.ASPECT_RATIO_SQUARE, 0.0f};
    ...
    class VectorDrawableCompatState extends ConstantState {
        ...
        public boolean hasTranslucentRoot() {
            return this.mVPathRenderer.getRootAlpha() < ValidationUtils.APPBOY_STRING_MAX_LENGTH ? true : VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (!(abs3 == 0.0f && abs4 == 0.0f)) {
                abs2 = FullImageView.ASPECT_RATIO_SQUARE;
                abs = FullImageView.ASPECT_RATIO_SQUARE;
            }
            ...
            if (min > 0 && height > 0) {
                ...
                if (needMirroring()) {
                    ...
                    canvas.scale(-1.0f, FullImageView.ASPECT_RATIO_SQUARE);
                }
